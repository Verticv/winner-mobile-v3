        ...
        <div style={{ width: '18rem', height: '16.5rem', marginBottom: '0.8125rem', padding: '0.1875rem', background: 'linear-gradient(to top, #1f1f1e, #343434 80%)', borderRadius: '0.5rem' }}>
            <div style={{ width: '100%', height: '100%', background: '#323232', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'space-between', borderRadius: '0.4rem' }}>
                <div className='flex flex-col items-center justify-around' style={{ paddingBottom: '1.5625rem', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'space-around' }}>
                    ...
                    {text1 && <span style={{ fontSize: '2.25rem', height: '2.34375rem', marginTop: '0.09rem', marginLeft: '0.1rem', letterSpacing: '-0.07rem', color: '#ccc2b6' }} className=" tracking-tight text-gray-r616161">{text1}</span>}
                    {text2 && <span style={{ fontSize: '2.25rem', height: '2.34375rem', marginTop: '0.375rem', letterSpacing: '-0.07rem', color: '#ccc2b6' }} className=" tracking-tight text-gray-r616161">{text2}</span>}
                </div>
                <span style={{ fontSize: '2.25rem', lineHeight: '1.625rem', marginBottom: '1.2rem', color: '#aa9264', letterSpacing: '-0.07rem' }} className="font-robotoBold tracking-tight text-blue-r0056a6">{count}</span>
            </div>
        </div>
    )
            ...
            <div>
                <div style={{ padding: '0', width: '100%', overflowX: 'scroll', marginBottom: '1rem' }}>
                    <table style={{ width: '513.2rem', padding: '', display: 'block', borderCollapse: 'collapse', background: 'rgba(36,36,36)' }}>
                        <thead style={{ height: '8.8125rem', color: '#ccc2b6', borderBottom: '0.1875rem solid #202020' }}>
                        ...
                        <tbody style={{ height: '8.8125rem', background: '#323232' }}>
                            <tr style={{ height: '8.8125rem', color: '#c8c8c8', letterSpacing: '-0.07rem', borderBottomLeftRadius: '1rem' }}>
                                <td style={{ width: '13.8125rem', textAlign: 'center', background: '#2c2c2c', color: '#ccc2b6' }}>변경</td>
                                ...
                                <td>
                                    ...
                                    >
                                        <div
                                            style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%', height: '100%', background: 'linear-gradient(to top, rgb(127, 95, 63), rgb(166, 124, 82))', borderRadius: '0.5625rem', letterSpacing: '-0.07rem' }}
                                        >
        ...
        <>
            <div>
                <div style={{ display: 'flex', }}>
                    <div style={{ width: '38.5rem', height: '5.7rem', border: '0.1875rem solid #635f5b', fontSize: '2.625rem', borderRadius: '3.5rem', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#2e2e2e', padding: '', marginTop: '1.8rem', marginLeft: '1rem', marginBottom: '1.8rem' }}>
                ...
                <div style={{ padding: '0', width: '100%', overflowX: 'scroll', marginBottom: '1rem' }}>
                    <table style={{ width: '474.625rem', padding: '', display: 'block', background: '', borderCollapse: 'collapse' }}>
                        <thead style={{ fontSize: '2.625rem', letterSpacing: '-0.07rem', background: '#242424', color: '#ccc2b6' }}>
                        ...
                        <tbody style={{ fontSize: '2.625rem', color: '#c8c8c8' }} className="w-full text-585858 text-14px tracking-tight ">
                            <tr style={{ height: '8.925rem', borderBottomWidth: '0.1875rem', borderBottom: '0.1875rem solid #202020', letterSpacing: '-0.07rem', background: '#323232', color: '#c8c8c8' }} className="flex items-center bg-gray-fefefe  tracking-tight text-gray-r454545 w-full border-b border-gray-dddddd">
                                <td style={{ width: '13.8125rem', textAlign: 'center', background: '#2c2c2c', color: '#ccc2b6' }} className="bg-gray-r7a848f h-full flex items-center justify-center  text-white tracking-tight">베팅금</td>
                            ...
                            <tr style={{ height: '8.625rem', fontSize: '2.625rem', borderBottomWidth: '0.1875rem', borderBottom: '0.1875rem solid #202020', background: '#2e2e2e' }} className="flex items-center bg-gray-fefefe  tracking-tight text-gray-r454545 w-full border-b border-gray-dddddd">
                                <td style={{ width: '13.8125rem', color: '#ccc2b6', textAlign: 'center', background: '#2c2c2c' }} className="bg-gray-r7a848f h-full flex items-center justify-center  text-white tracking-tight">승패</td>
                            ...
                            <tr style={{ height: '8.925rem', fontSize: '2.625rem', borderBottomWidth: '0.1875rem', background: '#323232' }} className="flex items-center bg-gray-fefefe  tracking-tight text-gray-r454545 w-full border-b border-gray-dddddd">
                                <td style={{ width: '13.8125rem', color: '#ccc2b6', textAlign: 'center', padding: '0.3rem 0 0 0.5rem', background: '#2c2c2c ' }} className="bg-gray-r7a848f h-full flex items-center justify-center  text-white tracking-tight">정산금액</td>
                ...
                <div style={{
                    ...
                    <div className="relative w-full h-full flex items-center justify-center" style={{ width: '18rem', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', position: 'relative', marginLeft: '0.9rem', marginRight: '-0.9rem' }}>
                        {item.user_count === 0
                            ...
                            >
                                <div
                                    style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%', height: '100%', background: isUserCountOpen[item.id] === true ? 'linear-gradient(to top, #b45a00, #f38d27)' : 'linear-gradient(#a67c52, #7f5f3f)', borderRadius: '0.5625rem', letterSpacing: '-0.07REM' }}
                                ...
                                >
                                    <span className=" tracking-tight text-white small-padding" style={{ color: 'rgb(255, 232, 189)' }}>
                    ...
                    <div className="test relative w-full h-full flex items-center justify-center" style={{ width: '18rem', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', position: 'relative', marginLeft: '', marginRight: '-0.1rem', paddingLeft: withPadding ? '2.5rem' : '5.1rem' }}>
                        ...
                        >
                            <div
                                style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%', height: '100%', background: isUserCountOpen[item.id + 1] === true ? 'linear-gradient(to top, #b45a00, #f38d27)' : 'linear-gradient(#a67c52, #7f5f3f)', borderRadius: '0.5625rem', letterSpacing: '-0.07REM' }}
                            ...
                            >
                                <span className=" tracking-tight text-white" style={{ color: 'rgb(255, 232, 189)' }}>
                    ...
                    <div className="relative w-full h-full flex items-center justify-center" style={{ width: '18rem', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', position: 'relative', paddingLeft: withPadding ? '5rem' : '' }}>
                        ...
                        >
                            <div
                                style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%', height: '100%', background: isUserCountOpen[item.id + 2] === true ? 'linear-gradient(to top, #b45a00, #f38d27)' : 'linear-gradient(#a67c52, #7f5f3f)', borderRadius: '0.5625rem', letterSpacing: '-0.07REM' }}
                    ...
                    {(isUserCountOpen[item.id] === true && item.hasSubArray === true) && (
                        <>
                            ...
                            >
                                ...
                                >
                                    <div style={{ height: '8.9625rem', fontSize: '2.625rem', background: 'rgb(36,36,36)', padding: !withPadding ? '0' : '0px 1.875rem', borderBottomWidth: '0.1875rem', display: 'flex', alignItems: 'center', color: '#ccc2b6', letterSpacing: '-0.07rem', justifyContent: 'space-evenly' }} className="test w-full bg-gray-r8e9296 border-b border-r border-l border-gray-dddddd flex items-center justify-evenly  text-white tracking-tight">
                                        ...
                                        >
                                            <p style={{ color: '#ccc2b6', fontSize: '2.625rem' }}>아이디</p>
                                        ...
                                        >
                                            <p style={{ color: '#ccc2b6', fontSize: '2.625rem' }}>출금액</p>
                                        ...
                                        >
                                            <p style={{ color: '#ccc2b6', fontSize: '2.625rem' }}>베팅액</p>
                                        ...
                                        >
                                            <p style={{ color: '#ccc2b6', fontSize: '2.625rem' }}>윈루즈</p>
                                        ...
                                        >
                                            <p style={{ color: '#ccc2b6', fontSize: '2.625rem' }}>포인트</p>
                                        ...
                                        >
                                            <div className="flex flex-col items-center justify-center" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                                                <div style={{ display: 'flex', alignItems: 'center', color: '#ccc2b6', fontSize: '2.625rem' }}>보유</div>
                                                <div className="flex items-center -mt-3.5" style={{ display: 'flex', alignItems: 'center', color: '#ccc2b6', fontSize: '2.625rem' }}>금액</div>
                                            </div>
        ...
        >
            ...
            >
                ...
                <div style={{
                    ...
                    <span style={{ fontSize: '2.8125rem', color: '#ccc2b6', letterSpacing: '-0.07rem' }} className="text-gray-r7b7b7b tracking-tight  pt-2">{name}</span>
                </div>
            </div>
        </div>
    )
            ...
            <div style={{ margin: '0', marginTop: '0', overflowX: 'hidden', marginRight: '0', marginBottom: '0' }} className="relative overflow-hidden flex flex-col h-full">
                <div style={{ marginLeft: '1.875rem', height: '11.1875rem', fontSize: '3rem', paddingTop: '' }} className='flex flex-col items-center'>
                    <div style={{ margin: 'auto', marginBottom: '0.25rem', background: '#272726', display: 'flex', width: '52rem', marginTop: '1.6rem', letterSpacing: '-0.07rem', height: '5rem', paddingTop: '0.7rem', borderRadius: '3rem', justifyContent: 'center' }} className="tracking-tight flex items-center">
                        <p style={{ margin: '0', color: '#aa9264', marginRight: '1rem', marginLeft: '1.4rem', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', maxWidth: '21.4rem' }}>{truncate('Louie3', 12, 12)}</p>
                        <p style={{ margin: '0', color: '#c8c8c8' }}>님의 총판 정보입니다.</p>
                    </div>
                </div>
                    ...
                    <div className="flex flex-col items-start w-full h-full">
                        ...
                        <div className="w-1836px">
                            <div style={{ marginLeft: '1.875rem', marginBottom: '1.4rem', display: 'flex', alignItems: 'center' }} className="w-full flex items-center tracking-tight text-gray-r7b7b7b ">
                                ...
                                <span style={{ fontSize: '3rem', marginTop: '', color: '#ccc2b6', letterSpacing: '-0.07rem' }}>총판현황</span>
                            </div>
                            ...
                            <div style={{ marginLeft: '1.875rem', marginBottom: '1.3rem', marginTop: '4rem', display: 'flex', alignItems: 'center' }} className="w-full flex items-center tracking-tight text-gray-r7b7b7b ">
                                <img style={{ width: '3.1875rem', marginRight: '0.8125rem' }} src={PieIcon} alt="" />
                                <span style={{ fontSize: '3rem', marginTop: '0rem', color: '#ccc2b6', letterSpacing: '-0.07rem' }}>롤링요율</span>
                            </div>
                                ...
                                <div style={{ padding: '0', width: '114.75rem', background: '#1e1e1e' }}>
                                    <div style={{ width: '75.925rem', overflowX: 'scroll', background: 'linear-gradient(to top, #1f1f1e, #343434 80%)', padding: '0.1875rem', margin: '0 1.7rem', boxShadow: '0 0rem 1rem 0 #000', borderTopLeftRadius: '1rem', borderBottomLeftRadius: '1rem' }} className="w-full overflow-scroll">
                                        <table style={{ width: '425.3rem', padding: '', display: 'block', borderCollapse: 'collapse', background: '#2e2e2e', borderTopRightRadius: '1rem', borderTopLeftRadius: '1rem', borderBottomLeftRadius: '1rem' }}>
                                            <thead style={{ height: '8.8125rem', color: '#ccc2b6', borderBottom: '0.1875rem solid #202020' }} className="w-full border-b border-gray-dddddd bg-gray-r8e9296  text-16px text-white tracking-tight">
                                                <tr style={{ height: '8.8125rem', letterSpacing: '-0.07rem' }}>
                                                    <td style={{ width: '14.5rem', fontSize: '2.625rem', textAlign: 'center', paddingRight: '1rem', paddingTop: '' }}>스포츠</td>
                                                    <td style={{ width: '14.5rem', fontSize: '2.625rem', textAlign: 'center', paddingTop: '' }}>미니게임</td>
                                            ...
                                            <tbody style={{ height: '8.8125rem', background: '#323232', borderBottomLeftRadius: '1rem' }} className="w-full text-585858 tracking-tight ">
                                                <tr style={{ height: '8.8125rem', color: '#c8c8c8', letterSpacing: '-0.07rem', borderBottomLeftRadius: '1rem' }} className="flex items-center bg-gray-fefefe  text-14px tracking-tight text-gray-r454545 w-full border-b border-gray-dddddd">
                            ...
                            <div style={{ marginLeft: '1.875rem', marginBottom: '1.1rem', marginTop: '5rem', display: 'flex', alignItems: 'center' }} className="w-full flex items-center tracking-tight text-gray-r7b7b7b ">
                                ...
                                <span style={{ fontSize: '3rem', marginTop: '0.4rem', letterSpacing: '-0.07rem', color: '#ccc2b6' }}>나의 상세내역</span>
                            </div>
                            ...
                            <div style={{ marginLeft: '1.875rem', marginTop: '4.3125rem', marginBottom: '0.75rem', display: 'flex', alignItems: 'center', letterSpacing: '-0.07rem' }} className="w-full flex items-center tracking-tight text-gray-r7b7b7b ">
                                ...
                                <div style={{ fontSize: '3rem', color: '#ccc2b6', marginTop: '0.1rem' }}>접속중인 회원수 : <span className="tracking-tight text-gray-r454545" style={{ color: '#c8c8c8' }}>2명</span></div>
                                ...
                                >
                                    ...
                                    >
                                        <span style={{
                                            fontSize: '2.625rem', color: '#ffdfbd',
                                            marginTop: '0.2rem',
                                            marginLeft: '-0.1rem',
                                ...
                                <div style={{ padding: '0', width: '114.75rem', background: '' }}>
                                    <div style={{ width: '75.625rem', borderRightWidth: '0', display: 'flex', flexDirection: 'column', overflow: 'scroll', background: '#1e1e1e' }}>
                                        <div style={{ width: '290.125rem', padding: '', display: 'flex', flexDirection: 'column', fontSize: '2.625rem' }}>
                                            <div style={{ height: '8.9625rem', fontSize: '2.625rem', background: '#2e2e2e', padding: '0px 1.875rem', borderBottom: '0.1875rem solid #202020', display: 'flex', alignItems: 'center', color: '#ccc2b6', letterSpacing: '-0.07rem' }}>
                                                <div style={{ width: '13rem', paddingLeft: '2.6rem', textAlign: '', paddingTop: '0.6rem' }}>번호</div>
                                                <button
                                                    style={{ padding: '0', margin: '0', background: 'bottom', width: '21.7rem', letterSpacing: '-0.07rem', paddingTop: '0.7rem', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', textAlign: 'center' }}
                                                    className="flex text-center items-center justify-center hover:opacity-75"
