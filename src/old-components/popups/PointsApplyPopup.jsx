        ...
        <div style={{ height: '100vh', flexDirection: 'row', display: 'flex', alignItems: 'center' }}>
            <div style={{ width: '72.125rem', maxWidth: '1154px', borderRadius: '3rem', background: '#323232', height: '78.1875rem', padding: '0.1875rem' }}>
                ...
                <div style={{ height: '9.3125rem', background: '#272726', borderTopLeftRadius: '3rem', borderTopRightRadius: '3rem', position: 'relative', display: 'flex', justifyContent: 'center', alignItems: 'center', }} className="relative bg-blue-r5d799c flex items-center justify-center flex-shrink-0">
                    <label style={{ fontSize: '3.75rem', color: '#ad9e8c', marginTop: '0.7rem', letterSpacing: '-0.1rem', marginLeft: '-0.4rem' }} className=" text-white tracking-tight">포인트 전환 신청</label>
                ...
                <div style={{ padding: '2.1rem 1.875rem' }} className="w-full h-full bg-white">
                    ...
                    <div style={{ margin: '1.6rem 0px 1.4rem -1.1rem', fontSize: '2.8125rem', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#929292', letterSpacing: '-0.2rem', marginLeft: '-1.1rem' }} className="flex items-center justify-center text-gray-r7c7c7c tracking-tight">
                        <span>사용 가능한 포인트: </span>
                        <span className="text-blue-r0056a6 ml-2px -mt-1 font-robotoBold" style={{ color: '#4c98ff' }}> &nbsp; 278</span>
                    ...
                    <div style={{ padding: "5.4rem 0", background: '#252525', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', borderRadius: '1.3rem', border: '0.1875rem solid #404040', letterSpacing: '-0.08rem' }} >
                        <div className='w-full text-center'>
                            <span style={{ fontSize: '2.811875rem', color: '#ccc2b6' }} className="tracking-tight text-gray-r454545">전환 포인트 입력</span>
                        </div>
                        ...
                        <div
                            ...
                            >
                                <div style={{ borderColor: "#ff8f63" }} className="w-full h-full flex items-center justify-center rounded-2xl border border-blue-r3ba3fc bg-gradient-to-b from-orange-ff7a45 via-orange-f56032 to-orange-e9441d cursor-pointer">
                                    <span style={{ fontSize: '2.8125rem', color: '#d6f3ff', display: 'inline-block', letterSpacing: '-0.07rem', marginTop: '0.5rem', marginLeft: '0.2rem' }} className='shadow-to-text'>포인트전환</span>
                                </div>
                            </button>
                        </div>
                        <div
                            ...
                            >
                                <div style={{ borderColor: "#ff8f63" }} className="w-full h-full flex items-center justify-center rounded-2xl border border-blue-r3ba3fc bg-gradient-to-b from-orange-ff7a45 via-orange-f56032 to-orange-e9441d cursor-pointer">
                                    <span style={{ fontSize: '2.8125rem', color: '#d6f3ff', display: 'inline-block', letterSpacing: '-0.07rem', marginTop: '0.5rem', marginLeft: '0.2rem' }} className='shadow-to-text'>상세내역</span>
                                </div>
                            </button>
                        </div>
                    </div>
