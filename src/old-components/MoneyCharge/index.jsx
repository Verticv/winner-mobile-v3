        ...
        <div style={{ padding: '1.875rem', paddingTop: '0.9rem' }}>
                ...
                <div style={{ padding: '0.7375rem 0.89rem', background: '#323232', borderRadius: '1.3rem' }}>
                    <div style={{ padding: '1.43rem 1.9rem 1rem 1.82rem', background: '#252525', borderRadius: '0.5rem', border: '0.1875rem solid #404040' }} className="w-full rounded-2xl border border-gray-dddddd bg-gray-f9f9f9">
                        ...
                        <div className='shadow-to-box' style={{ width: "36.4375rem", height: '7.3125rem', marginLeft: '15.7rem', borderRadius: '1rem', padding: '0.1875rem', marginBottom: '1.6rem', background: 'linear-gradient(to top, #4d3c0a, #b08b5a 50%, #e7b786)' }}>
                            ...
                            >
                                <div style={{ borderColor: "#ff8f63" }} className="w-full h-full flex items-center justify-center rounded-2xl border border-blue-r3ba3fc bg-gradient-to-b from-orange-ff7a45 via-orange-f56032 to-orange-e9441d cursor-pointer">
                                    <span style={{ fontSize: '2.8125rem', color: '#ffdfbd', display: 'inline-block', letterSpacing: '-0.07rem', marginTop: '0.2rem' }} className="shadow-to-text tracking-tight text-white">계좌번호 신청</span>
                                </div>
                            </button>
                        ...
                        <div style={{ fontSize: '2.625rem', color: '#c8c8c8', letterSpacing: '-0.07rem' }}>
                            <div style={{ display: 'flex', alignItems: 'center', lineHeight: '1.45' }}>
                                ...
                                <div style={{  color: '#c8c8c8', marginRight: '2rem' }}>
                                    위 <span className="text-gray-r454545 ml-3px" style={{  color: '#ffdfbd' }}>계좌번호 신청</span>버튼을 누르시면 계좌번호가 쪽지로 발송됩니다.
                                </div>
                            </div>
                            <div style={{ marginTop: '0.6875rem', display: 'flex', alignItems: 'center', lineHeight: '1.45' }}>
                                ...
                                <div className="" style={{ marginTop: '-0.2rem' }}>안내받은 계좌번호로 선입금 해주세요.</div>
                            </div>
                            <div style={{ marginTop: '0.6875rem', display: 'flex', alignItems: 'center' }}>
                                ...
                                <div style={{ lineHeight: '1.45', marginTop: '-0.1rem' }} className="">
                                    <span style={{  color: '#ffdfbd' }}>충전금액 입력</span>
                                    란에 실제 입금하신 금액과 동일한 금액을 입력하고
                                    <span style={{  color: '#ffdfbd' }}> 신청하기 </span>
                                    버튼을 눌러주세요.
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="form-section">
                            ...
                            <div className="lable-or-input" style={{ backgroundColor: '#191817' }}>
                                <div style={{ fontSize: '2.625rem' }}>
                                    <span className="font-robotoBold text-red-e9441d" style={{ color: '#e9441d' }}>487,240</span>
                                </div>
                    ...
                    <div style={{ padding: '0 1rem', display: 'flex', flexDirection: 'column' }} className="flex flex-col">
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', marginTop: '2.2rem', marginBottom: '1.9rem' }}>
                            ...
                            <p style={{ margin: '0', color: '#828282', fontSize: '2.625rem', letterSpacing: '-0.07rem', marginRight: '1rem' }}>
                            ...
                            >
                                ...
                                >
                                    <div style={{ display: 'flex', alignItems: 'center', width: '100%', height: '100%' }}>
                                        ...
                                        <span className='shadow-to-text' style={{ fontSize: '2.625rem', color: '#d6f3ff', letterSpacing: '-0.07rem', marginTop: '0.3rem' }}>슬롯게임</span>
                                    </div>
                                </button>
                            ...
                            >
                                ...
                                >
                                    <div style={{ display: 'flex', alignItems: 'center', width: '100%', height: '100%' }}>
                                        ...
                                        <span className='shadow-to-text' style={{ fontSize: '2.625rem', color: '#d6f3ff', letterSpacing: '-0.07rem', marginTop: '0.3rem' }}>스포츠</span>
                                    </div>
                                </button>
                            ...
                            >
                                ...
                                >
                                    <div style={{ display: 'flex', alignItems: 'center', width: '100%', height: '100%' }}>
                                        ...
                                        <span className='shadow-to-text' style={{ fontSize: '2.625rem', color: '#d6f3ff', letterSpacing: '-0.07rem', marginTop: '0.3rem' }}>키론가상게임</span>
                                    </div>
                                </button>
                            ...
                            >
                                ...
                                >
                                    <div style={{ display: 'flex', alignItems: 'center', width: '100%', height: '100%' }}>
                                        ...
                                        <span className='shadow-to-text' style={{ fontSize: '2.625rem', color: '#d6f3ff', letterSpacing: '-0.07rem', marginTop: '0.3rem' }}>피싱게임</span>
                                    </div>
                                </button>
                            ...
                            >
                                ...
                                >
                                    <div style={{ display: 'flex', alignItems: 'center', width: '100%', height: '100%' }}>
                                        ...
                                        <span className='shadow-to-text' style={{ fontSize: '2.625rem', color: '#ffd2d2', letterSpacing: '-0.07rem', marginTop: '0.3rem' }}>받지않기</span>
                                    </div>
                                </button>
                    ...
                    <div className='warning-message'>
                        <div style={{ display: 'flex', alignItems: 'center' }} >
                            ...
                            <div>
                                <span style={{ color: '#e65454', fontSize: '2.8125rem' }}>알아두세요</span>
                            </div>
                        </div>
            ...
            <div style={{ marginTop: '4.75rem', display: 'flex', flexDirection: 'row', justifyContent: 'center' }}>
                <button style={{ background: '#272726', width: '52rem', height: '6.5rem', borderRadius: '3.3rem', paddingTop: '0.15rem' }} className="">
                    <span className='' style={{ color: '#ad9e8c', fontSize: '2.625rem', letterSpacing: '-0.07rem' }}>은행점검시간</span>
                </button>
            </div>
