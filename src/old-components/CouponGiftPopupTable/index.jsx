...
const CouponGiftPopupTable = () => {
    ...
    return (
        <div style={{ borderRadius: "1.2rem", overflowY: 'scroll', background: '#2e2e2e', boxShadow: '0 0 2rem 0 rgba(0, 0, 0, 0.6)', height: 'calc(100vh - 58rem)' }} className="shadow-subNavbar overflow-y-scroll h-full">
            <div style={{ height: '7rem', color: '#ccc2b6', letterSpacing: '-0.07rem', paddingTop: '1.7rem', paddingRight: '' }}>
            ...
            <div style={{ color: '#c8c8c8', flex: 1 }}>
                <div style={{ height: '8.725rem', fontSize: '2.625rem', display: 'flex', alignItems: 'center', borderTop: '0.1875rem solid #252525', letterSpacing: '-0.07rem', background: '#323232' }}>
                ...
                <div style={{ height: '8.925rem', fontSize: '2.625rem', display: 'flex', alignItems: 'center', borderTop: '0.1875rem solid #252525', letterSpacing: '-0.07rem', background: '#2e2e2e' }}>
                ...
                <div style={{ height: '8.725rem', fontSize: '2.625rem', display: 'flex', alignItems: 'center', borderTop: '0.1875rem solid #252525', letterSpacing: '-0.07rem', background: '#2e2e2e' }}>
