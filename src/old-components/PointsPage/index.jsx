        ...
        <>
            <div style={{ padding: '1.75rem 1.875rem 0.975rem 1.9rem', display: 'flex' }}>
                <div style={{ borderRadius: "0.625rem", padding: '0.375rem', marginRight: '1rem', height: '13.125rem', background: 'linear-gradient(to top, #846241, #97714a 50%, #a47b51)', width: '36.5rem' }}>
                    <div style={{ borderRadius: "0.5rem", color: '#ad9e8c', paddingTop: '2.15rem', background: '#272624', width: '100%', height: '100%', display: 'flex', alignItems: 'center', flexDirection: 'column' }}>
                        ...
                        <div style={{ fontSize: '4.125rem', marginTop: '0.9rem', letterSpacing: '-0.13rem' }}>
                            <span style={{ color: '#4c98ff' }}>278</span>
                            <span>P</span>
                        </div>
                    </div>
                </div>
            ...
            <div style={{ padding: '1.875rem', paddingTop: '0', display: 'flex' }} className='w-full flex'>
                <div style={{ borderRadius: "0.625rem", padding: '0.375rem', marginRight: '1rem', height: '13.125rem', background: '#404040', width: '24rem' }}>
                    <div style={{ borderRadius: "0.5rem", color: '#ad9e8c', paddingTop: '2.15rem', background: '#272624', width: '100%', height: '100%', display: 'flex', alignItems: 'center', flexDirection: 'column', paddingRight: '0.35rem' }}>
                ...
                <div style={{ borderRadius: "0.625rem", padding: '0.375rem', marginRight: '1rem', height: '13.125rem', background: '#404040', width: '24rem' }}>
                    <div style={{ borderRadius: "0.5rem", color: '#ad9e8c', paddingTop: '2.15rem', background: '#272624', width: '100%', height: '100%', display: 'flex', alignItems: 'center', flexDirection: 'column', paddingRight: '0.26rem' }}>
