...
const EsportsMulti = () => {
    ...
    const Item = ({ number = "1.", title = "보유머니", text = null, text1 = null, text2 = null, text3 = null, text4 = null, text5 = null, text6 = null, text7 = null, color1 = null, color2 = null, color3 = null, withoutP }) => (
        <div style={{  lineHeight: '1.4', letterSpacing: '-0.05rem', fontSize: '2.625rem' }}>
    ...
    return (
        <div style={{ borderRadius: "1em", marginTop: '-0.3rem' }}>
            ...
            <div>
                ...
                <div style={{ backgroundColor: "#2b2b2a", padding: "2.15rem 1.8rem", marginTop: '2.4rem', borderRadius: '0.5rem', letterSpacing: '-0.05rem' }}>
                    <Item
                        number="2."
                        title="배당항목선택"
                        text="가. ①"
