                            ...
                            if (row[0]) {
                                ...
                                return (
                                    <div key={index} style={{ WebkitTextStroke: "0.2px", fontSize: '2.625rem', marginBottom: '0.375rem', color: firstColumnColor, letterSpacing: '-0.07rem', marginLeft: '0.14rem', display: 'flex', width: '100%' }}>
                                        ...
                                        {secondRowKeysName?.length > 0 && <><span className='text-gray-r585858' style={{ fontSize: '2.624375rem', color: '#ccc2b6', marginLeft: '3.725rem' }}>{secondRowKeysName[0]} : </span><span style={{  color: secondColumnColor }}> {row[1][secondRowKeysName[0]]}</span></>}
                                    </div>
                                )
                            }
                            return <></>
