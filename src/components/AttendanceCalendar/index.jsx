...
import Information from '../../assets/attendanceCalender/information.png';
...
class Calendar extends React.Component {
  ...
  renderHeader() {
    ...
    return (
      <div style={{ height: '6.625rem' }} className="content_1">
        <img
          style={{ height: '2.125rem', width: '1.3125rem' }}
        ...
        />
        <div
          style={{ fontSize: '2.625rem', margin: '0 2.6rem' }}
          className="content_2"
        >
          <div style={{ fontSize: '3.375rem' }} className="content_3">
            {format(this.state.currentMonth, dateFormat1)}
          </div>
          <div className="content_4">년 &nbsp;</div>
          <div style={{ fontSize: '3.375rem' }} className="content_5">
        ...
        <img
          style={{ height: '2.125rem', width: '1.3125rem' }}
          className={`${
            this.state.currentMonth < this.state.today
              ? 'content_7'
              : 'content_8'
          } content_9 `}
  ...
  renderDays() {
    return (
      <div
        style={{ height: '5.625rem', fontSize: '2.25rem' }}
        className="renderDays_Container"
      >
  ...
  renderCells() {
        ...
        days.push(
          ...
          >
            <div
              ...
              className={`${i === 0 ? 'Red_Content' : 'Gray_Content'} 
                            Day_Content`}
            >
              <p
                style={{
            ...
            {isSameMonth(day, monthStart) && (
              <img
                className="Day_Content2"
                src={
                  isChecked &&
                  format(currendDate, dateFormat1) === formattedDate1
                    ? AttendanceFilled
                    : AttendanceEmpty
                }
                alt=""
    ...
    return (
      <div
        style={{ height: '', width: '1112px' }}
        className="renderCells_Container"
      >
        {rows}
      </div>
    );
      ...
      <div className="Container">
        ...
        >
          ...
          >
            ...
            <div
              style={{ height: '5.5rem', fontSize: '2.25rem' }}
              className="calender_content1"
            >
              2021년 07월은 총<p className="calender_content2">7일</p>
              출석 하였습니다.
            </div>
          </div>
        </div>
        ...
        >
          <button className="Button_Style" onClick={this.checkAttendance}>
            <div className="button-content">
              <span className="span_style shadow-text-myPage">출석체크하기</span>
            </div>
          </button>
        </div>
      </div>
