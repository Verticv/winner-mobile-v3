...
const EsportsMulti = () => {
    ...
    >
      ...
      {text && (
        <p style={{ color: '#666666', fontSize: '2.625rem', margin: 0 }}>
          ...
          <span style={{ margin: '0' }}>{color3}</span>
        </p>
      )}
      {text1 && (
        <p
  ...
  return (
    <div style={{ borderRadius: '1em', marginTop: '-0.3rem', letterSpacing: '-0.025em' }}>
      <div>
        ...
        >
          ...
          >
            <div style={{ fontSize: '2.825rem' }}>
              <span style={{ color: '#682aa7', marginRight: '0.4rem', fontWeight: '700', }}>
                1.
              </span>
      ...
      <div>
        ...
        >
          ...
          <div style={{ alignItems: 'center', marginTop: '0.35rem' }}>
            <p style={{ color: '#8c8c8c', margin: 0, fontSize: '2.625rem' }}>
              ※ 각 팀의 좌/우 가장자리에 있는 ①
              <span
                style={{
                  margin: '0 0.5rem 0 0',
          ...
          <div style={{ color: '#8c8c8c', fontSize: '2.625rem' }}>
            <p style={{ color: '#8c8c8c', margin: 0 }}>
              {' '}
              선택한 경기(배당)가 ②팔레이 리스트에 추가됩니다.
            </p>
          </div>
          <div style={{ color: '#8c8c8c', fontSize: '2.625rem' }}>
            <p style={{ color: '#8c8c8c', margin: 0 }}>
              ※ 팔레이베팅은 최소 2개 이상 각각 다른 경기를 조합하여{' '}
            </p>
          </div>
          <div style={{ color: '#8c8c8c', fontSize: '2.625rem' }}>
            <p style={{ color: '#8c8c8c', margin: 0 }}>
              베팅할 수 있습니다. (같은 게임 팔레이베팅 불가){' '}
            </p>
          </div>
        </div>
      </div>
