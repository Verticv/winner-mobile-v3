    ...
    <div className="container">
      <div
        ...
        //   boxShadow: 'inset 0px 1px 0px 0px rgba(0, 0, 0, 0.2)',
          ...
          borderBottom: '0.1875rem solid #501771',
          borderTop: '0.1875rem solid #ca77e5',
          paddingTop: '0.2rem',
        }}
      ...
      >
        ...
        <div className="divcontent1">
          <div
            ...
            className="divcontent2"
          >
            {format(time, dateFormat, { locale: ko })}{' '}
            {format(time, dateFormat1, { locale: ko })}{' '}
            <p style={{ color: '#ffd98b', marginLeft: '0.6rem', fontWeight: '700' }} className="">
              [216회차]
            </p>
          </div>
          <div style={{ color: '#ffdfbd' }} className="divcontent3">
            <img
              ...
              alt=""
            />
            <p style={{ fontSize: '3.375rem', color: '#ffffff', fontWeight: '700' }}>02:16</p>
          </div>
        </div>
        <img
          style={{
