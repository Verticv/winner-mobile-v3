...
const SportsGamePolicyTable0 = ({ array }) => {
  const Cell = ({
    type,
    typeColor,
    overtime,
        ...
        >
          ...
          >
            <td
              ...
              className="text-center"
            >
              <p style={{ margin: '-0.1rem 0 0 1.3rem ' }}>타입 및 경기시간</p>
            </td>
            {/* <td
              style={{
                width: '14.1875rem',
              ...
              className="text-center"
            >
              <p style={{ margin: '-0.1rem 0 0 0rem ' }}>결과적용기준</p>
            </td> */}
            <td
              className="text-center"
              style={{
            ...
            >
              <p style={{ margin: '-0.1rem 0 0 -1.8rem ' }}>결과적용기준</p>
            </td>
          </tr>
        </thead>
        <tbody
...
export default SportsGamePolicyTable0;
