...
import ClockIcon from '../../assets/minigames/clock_purple.png';
import ClockIconWhite from '../../assets/minigames/clock_yellow.png';

import activeBG from '../../assets/cscenter/leftMenu/active-btn_v3.png';
import inactiveBG from '../../assets/inactive-bg1-v3.png';
  ...
  function TabsList({ items }) {
    return items.map((item, index) => (
      <button
        ...
        style={{
          background: `url(${
            selectedTab === item.path ? activeBG : inactiveBG
          }) round`,
          width: '20.7rem',
          height: '13.375rem',
          padding: '1px',
        ...
        className={`${
          selectedTab === item.path ? 'button-style' : 'button-style1'
        } button-style2`}
        onClick={() => {
          ...
          >
            ...
            >
              <span
                style={{
                  fontSize: '2.9875rem',
                  color: selectedTab === item.path ? '#ffffff' : '#5e399a',
                  fontWeight: '700'
            ...
            >
              <img
                style={{
                  width: '3.1875rem',
                  marginRight: '0.5875rem',
                  marginBottom: '1rem',
                  marginTop: '0.4rem',
                }}
                className="img-style"
                src={selectedTab === item.path ? ClockIconWhite : ClockIcon}
                alt=""
              />
              <div
                style={{
