                    ...
                    <div style={{
                        ...
                        <div style={{ marginRight: '' }} className="single-card-content3">
                            ...
                            <div style={{ height: '3.65rem' }}>
                                <p style={{ fontSize: '2.4375rem', color: '#444444' }} className="single-card-content7">1.95</p>
                            </div>
                        </div>
                        ...
                        <div className="single-card-content8">
                            ...
                            <div style={{ height: '3.65rem' }}>
                                <p style={{ fontSize: '2.4375rem', color: '#444444'}} className="single-card-content12 font-robotoRegular tracking-tight text-gray-r585858 -mt-3">1.95</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                >
                    ...
                    <div style={{
                        ...
                        <div style={{ marginRight: '' }} className="threecard-content8">
                            ...
                            <div style={{ height: '3.65rem' }}>
                                <p style={{ fontSize: '2.4375rem',color: '#444444' }} className="threecard-content12">3.75</p>
                            </div>
                        </div>
