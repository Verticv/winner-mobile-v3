            ...
            return (
                <button
                    className={`${isActive
                        ...
                        style={{ background: isActive ? 'linear-gradient(to top, rgb(73, 31, 156) 0%, rgb(158, 60, 188) 100%)' : 'rgb(229, 206, 250)', color: isActive ? '#ffffff' : 'rgb(45, 40, 52)', width: '49.2%', borderRadius: '4rem', marginTop: '1rem', height: '6.375rem', fontSize: '2.8125rem', marginRight: `${!index ? '1.15rem' : ''}`, border: `${pathname !== item.path && !isActive ? '0.1875rem solid #555555' : ''}`, letterSpacing: '-0.07rem' }}
                        key={item.id}
