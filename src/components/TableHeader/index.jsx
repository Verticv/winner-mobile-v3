...
const TableHeader = ({ smallCard = false, isMinigame = false, middleText = "무", isFreeboard, isCompose }) => {
    ...
    if (isMinigame === true) return (
        <div style={{ paddingTop: '1.7625rem', paddingBottom: '1.375rem', display: 'flex', justifyContent: 'right', alignItems: 'center', paddingRight: smallCard ? '1.8rem' : '10.5rem', letterSpacing: '-0.07rem', color: '#ccc2b6', background: '', marginBottom: '0.3rem' }} className="flex w-full pb-8 text-14px tracking-tight text-gray-r454545">
