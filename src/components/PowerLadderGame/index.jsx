    ...
    const PanelTitle = ({ title, titleNumber, subText, subText2, titleBg, isTopBorder = false, missingBorder, width }) => (
        <div style={{
            ...
            <div style={{ fontSize: '2.625rem', marginLeft: '0.75rem' }} className="powerladdergame-content10">
                <div className="powerladdergame-content11" style={{color: '#444444'}}>{subText} {subText2 ? `/${subText2}` : ''} </div>
            </div>
        </div>
    )
                    ...
                    <div style={{
                        ...
                        <div style={{ marginRight: '' }} className="powerladdergame-content13">
                            ...
                            <div style={{ height: '3.65rem' }}>
                                <p style={{ fontSize: '2.4375rem', color: '#444444' }} className="powerladdergame-content17">1.95</p>
                            </div>
                        </div>
                        ...
                        <div className="powerladdergame-content18">
                            ...
                            <div style={{ height: '3.65rem' }}>
                                <p style={{ fontSize: '2.4375rem', color: '#444444' }} className="powerladdergame-content22">1.95</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                >
                    ...
                    <div style={{
                        ...
                        <div style={{ marginRight: '' }} className="threecard-content3">
                            ...
                            <div style={{ height: '3.65rem' }}>
                                <p style={{ fontSize: '2.4375rem', color: '#444444' }} className="threecard-content9">3.80</p>
                            </div>
                        </div>
                        ...
                        <div style={{ marginRight: '' }} className="threecard-content10">
                            ...
                            <div style={{ height: '3.65rem' }}>
                                <p style={{ fontSize: '2.4375rem', color: '#444444' }} className="threecard-content16">3.80</p>
                            </div>
                        </div>
                        ...
                        <div style={{ marginRight: '' }} className="threecard-content17">
                            ...
                            <div style={{ height: '3.65rem' }}>
                                <p style={{ fontSize: '2.4375rem', color: '#444444' }} className="threecard-content23">3.80</p>
                            </div>
                        </div>
                        ...
                        <div style={{ marginRight: '' }} className="threecard-content24">
                            ...
                            <div style={{ height: '3.65rem' }}>
                                <p style={{ fontSize: '2.4375rem', color: '#444444' }} className="threecard-content30">3.80</p>
                            </div>
                        </div>
                    </div>
                </div>
