...
const Pagination = ({
  ...
  isBetHistoryPopup = false,
}) => {
  const LeftArrow = () => (
    <button
      style={{
        backgroundColor: selectedPage !== 1 && '#fff',
        width: '2.125rem',
        height: '2.125rem',
        marginRight: '3.1875rem',
        background: 'bottom',
  ...
  return (
    <div
      style={{
        marginBottom: withMarginBottom ? '16.25rem' : '0',
        display: 'flex',
        ...
        >
          <div style={{ marginTop: '-0.5rem' }}>
            <span
              ...
              className={`${
                selectedPage === 2 ? ' text-white' : ' text-gray-r454545'
              } font-roboto tracking-tight text-14px pt-2px`}
            >
              2
            </span>
          </div>
        ...
        >
          <div style={{ marginTop: '-0.5rem' }}>
            <span
              ...
              className={`${
                selectedPage === 3 ? ' text-white' : ' text-gray-r454545'
              } font-roboto tracking-tight text-14px pt-2px`}
            >
              3
            </span>
        ...
        >
          <div style={{ marginTop: '-0.5rem' }}>
            <span
              ...
              className={`${
                selectedPage === 4 ? ' text-white' : ' text-gray-r454545'
              } font-roboto tracking-tight text-14px pt-2px`}
            >
              4
            </span>
        ...
        >
          <div style={{ marginTop: '-0.5rem' }}>
            <span
              ...
              className={`${
                selectedPage === 5 ? ' text-white' : ' text-gray-r454545'
              } font-roboto tracking-tight text-14px pt-2px`}
            >
              5
            </span>
