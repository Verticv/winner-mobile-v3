...
const WinLoseSettlementContent = ({ activeButton, setActiveButton }) => {
    ...
    return (
        <div className="WinLoseSettlement">
            ...
            <div style={{ width: '73.875rem', height: '6.7rem', borderWidth: '0.1875rem', borderRadius: '3.1875rem', padding: '1.6rem 2rem', margin: '1.875rem 0', marginLeft: '1.875rem', display: 'flex', flexWrap: 'wrap', flexDirection: 'column', background: '#341d5a', border: '0.1875rem solid #9361e5' }}>
                <div style={{
                    ...
                    <div style={{ fontSize: '2.625rem', marginBottom: '1.55rem' }}>
                        <div style={{ display: 'flex', alignItems: 'center' }}>
                            ...
                            <div style={{ display: 'flex', alignItems: 'center' }}>
                                ...
                                }}>진행중인 금액 : <span style={{ color: '#ffcc00' }}>200,520,000</span></span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div style={{ width: '50%', display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: 'center' }}>
                    <div style={{ fontSize: '2.625rem', marginBottom: '1.55rem' }}>
                        <div style={{ display: 'flex', alignItems: 'center' }}>
                            ...
                            <div style={{ display: 'flex', alignItems: 'center' }}>
                                <span style={{ marginRight: '0.625rem', color: '#ffffff', letterSpacing: '-0.12rem' }}>정산 총 금액 : <span style={{ color: '#ffcc00' }}>500,000</span></span>
                            </div>
                        </div>
                    </div>
                </div>
