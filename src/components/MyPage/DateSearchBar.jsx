  ...
  return (
    <div
      style={{
        margin: withMargin
          ? !isFreeboard
            ? '0.65rem 1.875rem 0.9rem 1.876rem'
            : '1.2rem 1.875rem'
          : '0 3.875rem 0 0',
    ...
    >
      ...
      <div className="second-row">
        ...
        >
          ...
          <img
            ...
            alt=""
            style={{ width: '3.5rem' }}
            className="w-14 absolute right-8"
          />
        </div>
      ...
      {hasDateSuggestion ? (
        <div className="buttons-container2">
          ...
          {!hasIdSearch ? (
            <div
              className="common-button12"
              style={{
                background: withBlackButton
                  ? ''
            ...
            >
              ...
              >
                ...
                >
                  {withBlackButton ? '3개월' : '검색'}
                </span>
              </div>
            </div>
          ) : (
            <div
              style={{ width: '13.25rem', height: '7.3125rem' }}
      ...
      <div
        style={{
          ...
          marginBottom: withMargin ? '1.7rem' : '1.375rem',
          marginTop: '0',
          paddingBottom: '0.1rem',
          display: 'flex',
          alignItems: 'center',
          justifyContent: isDistributorPage? 'unset' : 'space-between',
        }}
      ...
      >
        ...
        {withBlackButton && (
          <div
            style={{
              minWidth: isDistributorPage ? '27.4375rem' : '70.1375rem',
              height: '7.25rem',
              background: 'linear-gradient(to top, #4f3a7a, #e597ff)',
              padding: '0.1875rem',
              margin: isDistributorPage ? '-0.6rem 0.125rem 1.75rem 1rem' : '-0.789rem 0.125rem 1.75rem 0.125rem',
