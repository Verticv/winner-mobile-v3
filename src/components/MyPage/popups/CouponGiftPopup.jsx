...
const CouponGiftPopup = ({ setPopupOpen }) => {
    return (
        ...
        <div style={{ height: "105vh", width: '77.625rem', borderTopLeftRadius: '3.75rem', borderTopRightRadius: '3.75rem', background: 'linear-gradient(to right, #ba76d0, #8865bd)', boxShadow: "0px 0px 3.125rem 0px rgba(0, 0, 0, 0.6),inset 0px 0.375rem 0px 0px rgba(255, 255, 255, 0.3)", paddingTop: '0.375rem', position: '', zIndex: '201' }}>
