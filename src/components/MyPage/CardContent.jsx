    ...
    <div className="cardContent">
      <div
        style={{
          ...
          display: 'flex',
          justifyContent:
            withUploadButton || withCancelButton ? 'space-between' : '',
          alignItems: 'center',
        }}
        className={`flex flex-wrap items-center h-full  ${
          withUploadButton || withCancelButton ? 'justify-between' : ''
        }`}
      >
        <div
          style={{
        ...
        >
          {withInput && (
            <div
              style={{
                margin: '-0.9rem 2.65rem 0px 0.7rem',
                marginTop: lastElement ? '-0.9rem' : '-0.9rem',
              }}
            ...
            {isPopup ? (
              <>
                ...
                >
                  ...
                  <span
                    style={{
                      color: winAmount.includes('+') ? '#e65454' : '#666666',
                    }}
                  >
                    {winAmount}
                  </span>
              ...
              <div
                className="flex"
                style={{ display: 'flex', letterSpacing: '-0.07rem' }}
              >
                <div
                  style={{
                    WebkitTextStroke: '0.2px',
        ...
        <div className="two-buttons-container">
          ...
          >
            ...
            >
              ...
              >
                <span style={{ color: '#ffffff' }}>내역삭제</span>
              </div>
            </div>
          </button>
        </div>
