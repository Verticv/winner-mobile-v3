...
const TableHeader2 = ({ smallCard = false, isMinigame = false, middleText = "무" }) => {
    ...
    return (
        <div style={{ paddingTop: '1.7625rem', paddingBottom: '1.4rem', display: 'flex', color: 'rgb(238, 238, 238)' , background: 'linear-gradient(to right, rgb(157, 59, 187), rgb(84, 35, 160))', borderTopLeftRadius: '1.125rem', borderTopRightRadius: '1.125rem' }} className="flex w-full  text-14px tracking-tight text-gray-r454545">
