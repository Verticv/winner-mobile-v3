...
const TableHeader2 = ({ smallCard = false, isMinigame = false, middleText = "무" }) => {
    ...
    return (
        <div style={{ paddingTop: '1.7625rem', paddingBottom: '1.4rem', display: 'flex', color: '#ccc2b6', background: '#323232', borderTopLeftRadius: '1rem', borderTopRightRadius: '1rem' }} className="flex w-full  text-14px tracking-tight text-gray-r454545">
