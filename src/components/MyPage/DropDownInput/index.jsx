...
const DropDownInput = ({
  isLeagueSelection = true,
  isBetCombination = false,
  withArrow,
}) => {
  const carrierOptions1 = [
    'league 1',
    'league 2',
    'league 3',
    'league 4',
  ...
  if (isBetCombination)
    return (
      ...
      >
        <div
          style={{ width: '34.06rem', height: '7rem', fontSize: '2.625rem', borderRadius: '1rem' }}
        ...
        >
          ...
          >
            <Dropdown
              withArrow
              multiple={true}
              labelStyle={{ marginLeft: '1.75rem', color: '#7b7b7b' }}
              options={carrierOptions3}
              isLeagueSelection={isLeagueSelection}
              labelClasses="pl-16"
            ></Dropdown>
          </div>
        </div>
        ...
        >
          <div style={{ borderWidth: '1px' }}>
            <Dropdown
              labelStyle={{ marginLeft: '1.75rem', color: '#7b7b7b' }}
              options={
                isLeagueSelection === true ? carrierOptions1 : carrierOptions2
              }
              isLeagueSelection={isLeagueSelection}
            >
              <img
