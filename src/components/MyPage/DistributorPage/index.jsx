...
import SummaryIcon from '../../../assets/mainPage/distributor/SummaryIcon-v3.png'
import PieIcon from '../../../assets/mainPage/distributor/pie-v3.png'
import DetailIcon from '../../../assets/mainPage/distributor/detail-v3.png'
import MemberIcon from '../../../assets/mainPage/distributor/member-v3.png'
import RecommendIcon from '../../../assets/mainPage/distributor/recommend-v3.png'
import SummaryIcon1 from '../../../assets/mainPage/distributor/SummaryIcon1-v3.png'
import SummaryIcon2 from '../../../assets/mainPage/distributor/SummaryIcon2-v3.png'
import SummaryIcon3 from '../../../assets/mainPage/distributor/SummaryIcon3-v3.png'
import SummaryIcon4 from '../../../assets/mainPage/distributor/SummaryIcon4-v3.png'
import SummaryIcon5 from '../../../assets/mainPage/distributor/SummaryIcon5-v3.png'
import SummaryIcon6 from '../../../assets/mainPage/distributor/SummaryIcon6-v3.png'
import SummaryIcon7 from '../../../assets/mainPage/distributor/SummaryIcon7-v3.png'
...
const DistributorPage = ({
    ...
    const SummaryCard = ({ text1, text2, img, count }) => (
        <div style={{ width: '18rem', height: '16.5rem', marginBottom: '0.8125rem', padding: '0.1875rem', background: 'linear-gradient(to top, #4f3a7a, #f0d3ff)', borderRadius: '0.563rem', boxShadow: "0px 2px 15px 0px rgba(0, 0, 0, 0.6)" }}>
            <div style={{ width: '100%', height: '100%', background: 'linear-gradient(to top, #ccc4ff, #ffd9f5)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'space-between', borderRadius: '0.463rem' }}>
                <div className='flex flex-col items-center justify-around' style={{ paddingBottom: '1.5625rem', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'space-around' }}>
                    <img style={{ marginTop: '1.288rem', marginLeft: "-0.063rem", width: '5.063rem' }} src={img} alt="" />
                    {text1 && <span style={{ fontSize: '2.25rem', height: '2.34375rem', marginTop: '-0.035rem', marginLeft: '0.1rem', letterSpacing: '-0.07rem', color: '#2d2834' }} className=" tracking-tight text-gray-r616161">{text1}</span>}
                    {text2 && <span style={{ fontSize: '2.25rem', height: '2.34375rem', marginTop: '0.375rem', letterSpacing: '-0.07rem', color: '#2d2834' }} className=" tracking-tight text-gray-r616161">{text2}</span>}
                </div>
                <span style={{ fontSize: '2.25rem', lineHeight: '1.625rem', marginBottom: '1.513rem', color: '#c03a41', letterSpacing: '-0.07rem' }} className="font-robotoBold tracking-tight text-blue-r0056a6">{count}</span>
            </div>
        </div>
    )
        ...
        <>
            <div>
                <div style={{ padding: '0', width: '100%', overflowX: 'scroll', marginBottom: '1rem' }}>
                    <table style={{ width: '513.2rem', padding: '', display: 'block', borderCollapse: 'collapse', background: '#5d4386' }}>
                        <thead style={{ height: '8.8125rem', color: '#eeeeee', borderBottom: '0.1875rem solid #dddddd' }}>
                            <tr style={{ height: '8.8125rem', letterSpacing: '-0.07rem' }}>
                                <td style={{ width: '13.8125rem', textAlign: 'center', background: '#3f2a5f' }}>구분</td>
                        ...
                        <tbody style={{ height: '8.8125rem', background: '#ffffff' }}>
                            <tr style={{ height: '8.8125rem', color: '#666666', letterSpacing: '-0.07rem', borderBottomLeftRadius: '1rem' }}>
                                <td style={{ width: '13.8125rem', textAlign: 'center', background: '#f8f9f9', color: '#666666' }}>변경</td>
                                ...
                                <td>
                                    <button
                                        ...
                                        style={{ width: "11rem", height: '6.375rem', fontSize: '2.4375rem', display: 'flex', justifyContent: 'center', alignItems: 'center', background: 'linear-gradient(to top, rgb(79, 58, 122), rgb(229, 151, 255))', padding: '0.1875rem', borderRadius: '1.125rem' }}
                                    >
                                        <div
                                            style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%', height: '100%', background: 'linear-gradient(to top, rgb(107, 34, 255), rgb(223, 82, 255))', borderRadius: '1.125rem', letterSpacing: '-0.07rem' }}
                                        >
                                            <span className="small-padding shadow-to-text" style={{ color: '#ffffff' }}>
                                                수정
                                            </span>
        ...
        <>
            <div>
                <div style={{ display: 'flex', }}>
                    <div style={{ width: '38.5rem', height: '5.7rem',  fontSize: '2.625rem', borderRadius: '3.5rem', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#6852a7', padding: '', marginTop: '1.8rem', marginLeft: '1rem', marginBottom: '1.8rem' }}>
                        <img style={{ width: '1.438rem', height: '1.3125rem', marginRight: '1.5rem' }} src={Diamond1} alt="" />
                        <div style={{ marginTop: '0.15rem' }}>
                            <span style={{ color: '#ffffff' }}>입금 :</span>
                    ...
                    <div style={{ width: '38.5rem', height: '5.7rem', fontSize: '2.625rem', borderRadius: '3.5rem', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#6852a7', padding: '', marginTop: '1.8rem', marginLeft: '1rem', marginBottom: '1.8rem' }}>
                        <img style={{ width: '1.438rem', height: '1.3125rem', marginRight: '1.5rem' }} src={Diamond1} alt="" />
                        <div style={{ marginTop: '0.15rem' }}>
                            <span style={{ color: '#ffffff' }}>보너스 :</span>
                    ...
                    <div style={{ width: '38.5rem', height: '5.7rem', fontSize: '2.625rem', borderRadius: '3.5rem', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#6852a7', padding: '', marginTop: '1.8rem', marginLeft: '1rem', marginBottom: '1.8rem' }}>
                        <img style={{ width: '1.438rem', height: '1.3125rem', marginRight: '1.5rem' }} src={Diamond1} alt="" />
                        <div style={{ marginTop: '0.15rem' }}>
                            <span style={{ color: '#ffffff' }}>출금 :</span>
                            <span style={{ color: '#ffcc00', letterSpacing: '0', marginLeft: '0.625rem' }}>{truncate("0", 15, 15)}</span>
                        </div>
                    </div>
                </div>
                <div style={{ padding: '0', width: '100%', overflowX: 'scroll', marginBottom: '1rem' }}>
                    <table style={{ width: '474.625rem', padding: '', display: 'block', background: '', borderCollapse: 'collapse' }}>
                        <thead style={{ fontSize: '2.625rem', letterSpacing: '-0.07rem', background: '#5d4386', color: '#eeeeee' }}>
                            <tr style={{ height: '8.925rem', borderBottom: '0.1875rem solid #dddddd' }}>
                                <td style={{ width: '13.8125rem', textAlign: 'center', background: '#3f2a5f' }}>구분</td>
                                ...
                                <td style={{ width: '14.8125rem', textAlign: 'center', paddingTop: '0.5rem', paddingRight: '0.5rem', letterSpacing: '-0.1rem' }}><span style={{letterSpacing:'-0.24rem'}}>프레그메틱</span><br /><span >플레이</span></td>
                                ...
                                <td style={{ width: '13.8125rem', textAlign: 'center', paddingTop: '0.5rem' }} className="text-center h-full flex items-center justify-center">e-스포츠</td>
                                <td style={{ width: '13.8125rem', textAlign: 'center', paddingTop: '0.5rem' }}><span>키론</span><br /><span>가상게임</span></td>
                                <td style={{ width: '13.8125rem', textAlign: 'center', paddingTop: '0.5rem', background: '#3f2a5f' }}>합계</td>
                            </tr>
                        </thead>
                        <tbody style={{ fontSize: '2.625rem', color: '#666666' }} className="w-full text-585858 text-14px tracking-tight ">
                            <tr style={{ height: '8.925rem', borderBottomWidth: '0.1875rem', borderBottom: '0.1875rem solid #dddddd', letterSpacing: '-0.07rem', background: '#ffffff', color: '#666666' }} className="flex items-center bg-gray-fefefe  tracking-tight text-gray-r454545 w-full border-b border-gray-dddddd">
                                <td style={{ width: '13.8125rem', textAlign: 'center', background: '#f2f2f2', color: '#666666' }} className="bg-gray-r7a848f h-full flex items-center justify-center  text-white tracking-tight">베팅금</td>
                                ...
                                <td style={{ backgroundColor: "#f2f2f2", color: "", width: '13.8125rem', textAlign: 'center', paddingRight: '1.2rem', paddingBottom: '0.2rem' }} className="text-right pr-4 h-full flex items-center justify-end">7.14M</td>
                            </tr>
                            <tr style={{ height: '8.625rem', fontSize: '2.625rem', borderBottomWidth: '0.1875rem', borderBottom: '0.1875rem solid #dddddd', background: '#f7f7f7' }} className="flex items-center bg-gray-fefefe  tracking-tight text-gray-r454545 w-full border-b border-gray-dddddd">
                                <td style={{ width: '13.8125rem', color: '#666666', textAlign: 'center', background: '#f2f2f2' }} className="bg-gray-r7a848f h-full flex items-center justify-center  text-white tracking-tight">승패</td>
                                ...
                                <td style={{ backgroundColor: "#f2f2f2", color: "", width: '13.8125rem', textAlign: 'right', paddingRight: '3.8rem', paddingBottom: '0.4rem' }} className="text-right pr-4 h-full flex items-center justify-end">0</td>

                            </tr>
                            <tr style={{ height: '8.925rem', fontSize: '2.625rem', borderBottomWidth: '0.1875rem', background: '#ffffff' }} className="flex items-center bg-gray-fefefe  tracking-tight text-gray-r454545 w-full border-b border-gray-dddddd">
                                <td style={{ width: '13.8125rem', color: '#666666', textAlign: 'center', padding: '0.3rem 0 0 0.5rem', background: '#f2f2f2' }} className="bg-gray-r7a848f h-full flex items-center justify-center  text-white tracking-tight">정산금액</td>
    ...
    function RecommendedUserCell({ items, withPadding }) {
        ...
        return items.map(item => (
            <>
                <div style={{
                    fontSize: '2.625rem', height: '11.2rem', display: 'flex', alignItems: 'center', justifyContent: 'space-evenly',
                    ...
                    {item.name && (
                        <div className="w-full h-full flex items-center justify-center " style={{ width: '16.6rem', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>{item.name}</div>
                    )}
                    <div className="w-full h-full flex items-center justify-center " style={{ width: '18rem', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', paddingLeft: '3.5rem' }}>{item.nickname}</div>
                    <div className="relative w-full h-full flex items-center justify-center" style={{ width: '18rem', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', position: 'relative', marginLeft: '0.9rem', marginRight: '-0.9rem' }}>
                        {item.user_count === 0
                            ? <div className="" style={{}}>{item.added_amount}</div>
                            :
                            <button
                                style={{ width: "11rem", height: '6.375rem', fontSize: '2.4375rem', display: 'flex', justifyContent: 'center', alignItems: 'center', background: 'linear-gradient(to top, #4f3a7a, #e597ff)', padding: '0.1875rem', borderRadius: '1.125rem' }}
                            ...
                            >
                                <div
                                    style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%', height: '100%', background: isUserCountOpen[item.id] === true ? 'linear-gradient(to top, #6b22ff, #df52ff)' : 'linear-gradient(to top, #6b22ff, #df52ff)', borderRadius: '1.125rem', letterSpacing: '-0.07REM' }}
                                ...
                                >
                                    <span className=" tracking-tight text-white small-padding" style={{ color: '#ffffff' }}>
                    ...
                    <div className="w-full text-center flex flex-col items-center justify-center" style={{ width: '18rem', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                        ...
                        <div className="flex items-center -mt-3.5 ">({item.absent_date})</div>
                    </div>
                    <div className="test relative w-full h-full flex items-center justify-center" style={{ width: '18rem', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', position: 'relative', marginLeft: '', marginRight: '-0.1rem', paddingLeft: withPadding ? '2.5rem' : '5.1rem' }}>
                        ...
                        >
                            <div
                                style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%', height: '100%', background: isUserCountOpen[item.id + 1] === true ? 'linear-gradient(to top, #6b22ff, #df52ff)' : 'linear-gradient(to top, #6b22ff, #df52ff)', borderRadius: '1.125rem', letterSpacing: '-0.07REM' }}
                            ...
                            >
                                <span className=" tracking-tight text-white" style={{ color: '#ffffff' }}>
                    ...
                    <div className="relative w-full h-full flex items-center justify-center" style={{ width: '18rem', height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', position: 'relative', paddingLeft: withPadding ? '5rem' : '' }}>
                        <button
                            style={{ width: "11rem", height: '6.375rem', fontSize: '2.4375rem', display: 'flex', justifyContent: 'center', alignItems: 'center', background: 'linear-gradient(to top, #4f3a7a, #e597ff)', padding: '0.1875rem', borderRadius: '1.125rem', marginRight: !withPadding ? '-8rem' : '' }}
                            className={`${isUserCountOpen ? "bg-blue-r0070d9" : "bg-blue-r2068b2"} hover flex items-center justify-center rounded-lg hover:opacity-75 shadow-to-box shadow-to-text`}
                            onClick={() => {
                        ...
                        >
                            <div
                                style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', width: '100%', height: '100%', background: isUserCountOpen[item.id + 2] === true ? 'linear-gradient(to top, #6b22ff, #df52ff)' : 'linear-gradient(to top, #6b22ff, #df52ff)', borderRadius: '1.125rem', letterSpacing: '-0.07REM' }}
                ...
                <div
                    style={{
                        ...
                        borderTop: (isUserCountOpen[item.id] === true || isUserCountOpen[item.id + 1] === true || isUserCountOpen[item.id + 2] === true) && "0.375rem solid #6b22ff",
                        opacity: '0.9',
                    }}
                    ...
                    {(isUserCountOpen[item.id] === true && item.hasSubArray === true) && (
                        <>
                            ...
                            >
                                ...
                                >
                                    <div style={{ height: '8.9625rem', fontSize: '2.625rem', background: '#5d4386', padding: !withPadding ? '0' : '0px 1.875rem', borderBottomWidth: '0.1875rem', display: 'flex', alignItems: 'center', color: '#eeeeee', letterSpacing: '-0.07rem', justifyContent: 'space-evenly' }} className="test w-full bg-gray-r8e9296 border-b border-r border-l border-gray-dddddd flex items-center justify-evenly  text-white tracking-tight">
                                        ...
                                        >
                                            <p style={{ color: '#eeeeee', fontSize: '2.625rem' }}>아이디</p>
                                            <img style={{ width: '1.9375rem', height: '1.3125rem', marginLeft: '0.4375rem', transform: subArrowClicked[0] === true ? "rotate(180deg)" : "" }} src={WhiteArrow1} className={`${isArrowUp[0] === true ? "transform rotate-180" : ""}`} alt="" />
                                        </button>
                                        <div style={{ width: '18rem', textAlign: 'center', paddingLeft: '3.4rem', paddingTop: '0.6rem' }} className="text-center -mt-3.5">별명</div>
                                        <button
                                            style={{ margin: '0', padding: '0', width: '18rem', height: '100%', background: 'bottom', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
                                        ...
                                        >
                                            <div className="flex flex-col items-center justify-center" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', color: '#ccc2b6', fontSize: '2.625rem', marginTop: '1.2rem' }}>
                                                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', color: "#eeeeee" }}>하부</div>
                                                <div className="flex items-center -mt-3.5" style={{ display: 'flex', alignItems: 'center', marginTop: '' , color: "#eeeeee"}}>유저수</div>
                                            </div>
                                            <img style={{ width: '1.9375rem', height: '1.3125rem', marginLeft: '0.4375rem', transform: subArrowClicked[1] === false ? "rotate(180deg)" : "" }} src={WhiteArrow1} className={`${isArrowUp[1] === false ? "transform rotate-180" : ""}`} alt="" />
                                        </button>
                                        <button
                                        ...
                                        >
                                            <div className="flex flex-col items-center justify-center" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', color: '#ccc2b6', fontSize: '2.625rem' }}>
                                                <div style={{ height: '3.29rem', marginTop: '0.2rem', display: 'flex', alignItems: 'center', color: "#eeeeee" }}>추천일시</div>
                                                <div style={{ height: '3.29rem', display: 'flex', alignItems: 'center', margin: '-0.5rem 0', color: "#eeeeee" }} className="flex items-center -mt-3.5">로그인일시</div>
                                                <div style={{ height: '3.29rem', display: 'flex', alignItems: 'center', color: "#eeeeee" }} className="flex items-center -mt-3.5">(미접속일수)</div>
                                            </div>
                                            <img style={{ width: '1.9375rem', height: '1.3125rem', marginLeft: '0.4375rem', fontSize: '2.4rem', transform: subArrowClicked[2] === false ? "rotate(180deg)" : "" }} src={WhiteArrow1} className={`${isArrowUp[2] === false ? "transform rotate-180" : ""}`} alt="" />
                                        </button>
                                        ...
                                        >
                                            <p style={{ color: '#eeeeee', fontSize: '2.625rem' }}>출금액</p>
                                            <img style={{ width: '1.9375rem', height: '1.3125rem', marginLeft: '0.4375rem', transform: subArrowClicked[3] === false ? "rotate(180deg)" : "" }} src={WhiteArrow1} className={`${isArrowUp[3] === false ? "transform rotate-180" : ""}`} alt="" />
                                        </button>
                                        ...
                                        >
                                            <p style={{ color: '#eeeeee', fontSize: '2.625rem' }}>베팅액</p>
                                            <img style={{ width: '1.9375rem', height: '1.3125rem', marginLeft: '0.4375rem', transform: subArrowClicked[4] === false ? "rotate(180deg)" : "" }} src={WhiteArrow1} className={`${isArrowUp[4] === false ? "transform rotate-180" : ""}`} alt="" />
                                        </button>
                                        <button
                                        ...
                                        >
                                            <p style={{ color: '#eeeeee', fontSize: '2.625rem' }}>윈루즈</p>
                                            <img style={{ width: '1.9375rem', height: '1.3125rem', marginLeft: '0.4375rem', transform: subArrowClicked[5] === false ? "rotate(180deg)" : "" }} src={WhiteArrow1} className={`${isArrowUp[5] === false ? "transform rotate-180" : ""}`} alt="" />
                                        </button>
                                        ...
                                        >
                                            <p style={{ color: '#eeeeee', fontSize: '2.625rem' }}>포인트</p>
                                            <img style={{ width: '1.9375rem', height: '1.3125rem', marginLeft: '0.4375rem', transform: subArrowClicked[6] === false ? "rotate(180deg)" : "" }} src={WhiteArrow1} className={`${isArrowUp[6] === false ? "transform rotate-180" : ""}`} alt="" />
                                        </button>
                                        <button
                                            style={{ padding: '0', margin: '0', background: 'bottom', width: '18rem', height: '100%', display: 'flex', textAlign: 'center', alignItems: 'center', justifyContent: 'center' }}
                                            className="text-center flex items-center justify-center hover:opacity-75"
                                        ...
                                        >
                                            <div className="flex flex-col items-center justify-center" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                                                <div style={{ display: 'flex', alignItems: 'center', color: '#eeeeee', fontSize: '2.625rem' }}>보유</div>
                                                <div className="flex items-center -mt-3.5" style={{ display: 'flex', alignItems: 'center', color: '#eeeeee', fontSize: '2.625rem' }}>금액</div>
                                            </div>
                                            <img style={{ width: '1.9375rem', height: '1.3125rem', marginLeft: '0.4375rem', transform: subArrowClicked[7] === false ? "rotate(180deg)" : "" }} src={WhiteArrow1} className={`${isArrowUp[7] === false ? "transform rotate-180" : ""}`} alt="" />
                                        </button>
                                    </div>
        ...
        >
            ...
            >
                ...
                <div style={{
                    ...
                    alignItems: 'center',
                    paddingTop: '0.3rem',
                    boxShadow: "0px 0.375rem 0.563rem 0px rgba(0, 0, 0, 0.5)"
                }} className="h-full w-full rounded-full flex items-center">
                    <img style={{ width: '3.938rem', height: '3.9375rem', marginRight: '0.7rem', marginTop: '-0.4rem' }} className='mr-3' src={DefaultUser} alt="" />
                    <span style={{ fontSize: '2.8125rem', color: '#666666', letterSpacing: '-0.07rem' }} className="text-gray-r7b7b7b tracking-tight  pt-2">{name}</span>
                </div>
            </div>
        </div>
    )
            ...
            <div style={{ margin: '0', marginTop: '0', overflowX: 'hidden', marginRight: '0', marginBottom: '0' }} className="relative overflow-hidden flex flex-col h-full">
                <div style={{ marginLeft: '-0.063rem', height: '11.1875rem', fontSize: '3rem', paddingTop: '' }} className='flex flex-col items-center'>
                    <div style={{ margin: 'auto', marginBottom: '0.25rem', background: '#342267', display: 'flex', width: '48.938rem', marginTop: '1.476rem', letterSpacing: '-0.07rem', height: '5.063rem', paddingTop: '0.7rem', borderRadius: '3rem', justifyContent: 'center' }} className="tracking-tight flex items-center">
                        <p style={{ margin: '0', color: '#a5eefe', marginRight: '1rem', marginLeft: '1.4rem', marginTop: "-0.251rem", overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', maxWidth: '21.4rem' }}>{truncate('Louie3', 12, 12)}</p>
                        <p style={{ margin: '0',marginTop: "-0.251rem", color: '#ffffff' }}>님의 총판 정보입니다.</p>
                    </div>
                </div>
                ...
                <div style={{ marginTop: '1.3rem' }} className="relative flex flex-col justify-start limit:justify-center">
                    ...
                    <div className="flex flex-col items-start w-full h-full">
                        ...
                        <div className="w-1836px">
                            <div style={{ marginLeft: '1.875rem', marginBottom: '1.4rem', display: 'flex', alignItems: 'center' }} className="w-full flex items-center tracking-tight text-gray-r7b7b7b ">
                                <img style={{ width: '3.063rem', height: '3.313rem', marginRight: '0.8125rem', marginTop: '-0.05rem' }} src={SummaryIcon} alt="" />
                                <span style={{ fontSize: '3rem', marginTop: '-0.25rem', color: '#eeeeee', letterSpacing: '-0.07rem' }}>총판현황</span>
                            </div>

                            <div style={{ paddingTop: "0.125rem", marginLeft: '1.875rem', width: '73.7rem', display: 'flex', flexWrap: 'wrap' }} className="flex w-full flex-wrap">
                            ...
                            <div style={{ marginLeft: '1.875rem', marginBottom: '1.3rem', marginTop: '3.75rem', display: 'flex', alignItems: 'center' }} className="w-full flex items-center tracking-tight text-gray-r7b7b7b ">
                                <img style={{ width: '3.25rem', marginRight: '0.8125rem', marginTop: "0.125rem" }} src={PieIcon} alt="" />
                                <span style={{ fontSize: '3rem', marginTop: '-0.125rem', color: '#eeeeee', letterSpacing: '-0.07rem' }}>롤링요율</span>
                            </div>

                            <div className='flex relative div-shadow' style={{ display: 'flex', position: 'relative' }}>
                                <div style={{ padding: '0', width: '114.75rem', marginLeft: "0.125rem" }}>
                                    <div style={{ width: '75.925rem', overflowX: 'scroll', background: 'linear-gradient(to top, #eeeeee, #9362e5)', padding: '0.1875rem', margin: '0 1.7rem', boxShadow: '0 0rem 1rem 0 #000', borderTopLeftRadius: '1rem', borderBottomLeftRadius: '1rem' }} className="w-full overflow-scroll">
                                        <table style={{ width: '425.3rem', padding: '', display: 'block', borderCollapse: 'collapse', background: '#472480', borderTopRightRadius: '1rem', borderTopLeftRadius: '1rem', borderBottomLeftRadius: '1rem' }}>
                                            <thead style={{ height: '8.75rem', color: '#eeeeee' }} className="w-full border-b border-gray-dddddd bg-gray-r8e9296  text-16px text-white tracking-tight">
                                                <tr style={{ height: '8.75rem', letterSpacing: '-0.07rem' }}>
                                                    <td style={{ width: '17rem', fontSize: '2.625rem', textAlign: 'center', paddingRight: '1rem', paddingTop: '' }}>스포츠</td>
                                                    <td style={{ width: '17.688', fontSize: '2.625rem', textAlign: 'center', paddingTop: '' }}>미니게임</td>
                                                    <td style={{ width: '19.5rem', fontSize: '2.625rem', textAlign: 'center', paddingLeft: '1rem' }}><span style={{letterSpacing:'-0.24rem'}}>프레그메틱</span><br /><span>플레이</span></td>
                                                    <td style={{ width: '16.563rem', fontSize: '2.625rem', textAlign: 'center', paddingTop: '', paddingLeft: '1.4rem' }}>에볼루션</td>
                                                    <td style={{ width: '17.688rem', fontSize: '2.625rem', textAlign: 'center', paddingTop: '', paddingLeft: '1.4rem' }}>로얄지</td>
                                            ...
                                            <tbody style={{ height: '8.8125rem', background: '#ffffff', borderBottomLeftRadius: '1rem' }} className="w-full text-585858 tracking-tight ">
                                                <tr style={{ height: '9.063rem', color: '#666666', letterSpacing: '-0.07rem', borderBottomLeftRadius: '1rem' }} className="flex items-center bg-gray-fefefe  text-14px tracking-tight text-gray-r454545 w-full border-b border-gray-dddddd">
                            ...
                            <div style={{ marginLeft: '1.875rem', marginBottom: '1.1rem', marginTop: '5rem', display: 'flex', alignItems: 'center' }} className="w-full flex items-center tracking-tight text-gray-r7b7b7b ">
                                <img style={{ width: '3.25rem', marginRight: '0.8125rem', marginTop: '0.075rem' }} src={DetailIcon} alt="" />
                                <span style={{ fontSize: '3rem', marginTop: '-0.288rem', letterSpacing: '-0.07rem', color: '#eeeeee' }}>나의 상세내역</span>
                            </div>
                            ...
                            <div style={{ width: '73.875rem', height: '12.7rem', borderWidth: '0.375rem', borderRadius: '3.188rem', padding: '2.2rem 2.75rem', margin: '1.875rem 0', marginLeft: '1.875rem', display: 'flex', flexWrap: 'wrap', flexDirection: 'column', background: '#341d5a', border: '0.375rem solid #9361e5' }} className="flex flex-wrap w-full border-2 border-gray-b4b4b4 bg-gray-r5a6067">
                                <div className='w-1/2 flex flex-wrap items-center justify-center' style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', marginLeft: '0.2rem', width: '50%' }}>
                                    <div style={{ fontSize: '2.5rem', marginBottom: '1.55rem' }} className="w-full  tracking-tight">
                                        <div className='flex items-center' style={{ display: 'flex', alignItems: 'center' }}>
                                            <img style={{ width: '1.438rem', height: '1.2rem', marginRight: '1.2rem' }} src={Diamond} alt="" />
                                    ...
                                    <div style={{ fontSize: '2.5rem' }} className="w-full  tracking-tight">
                                        <div className='flex items-center' style={{ display: 'flex', alignItems: 'center' }}>
                                            <img style={{ width: '1.438rem', height: '1.3125rem', marginRight: '1.2rem' }} src={Diamond} alt="" />
                                            <div style={{ display: 'flex', alignItems: 'center' }}>
                                ...
                                <div className='w-1/2 flex flex-wrap items-center justify-center' style={{ width: '50%', display: 'flex', flexWrap: 'wrap', alignItems: 'center', justifyContent: '' }}>
                                    <div style={{ fontSize: '2.5rem', marginBottom: '1.55rem' }} className="w-full  tracking-tight">
                                        <div className='flex items-center' style={{ display: 'flex', alignItems: 'center' }}>
                                            <img style={{ width: '1.438rem', height: '1.2rem', marginRight: '1.3125rem' }} src={Diamond} alt="" />
                                            <div style={{ display: 'flex', alignItems: 'center' }}>
                            ...
                            <div className='flex relative div-shadow' style={{ display: 'flex', position: 'relative' }}>
                                <div style={{ padding: '0', width: '114.75rem' }}>
                                    <div style={{ width: '75.625rem', background: 'linear-gradient(to top, #eeeeee, #9362e5)', borderTopLeftRadius: '0.4rem', borderBottomLeftRadius: '0.4rem', overflow: 'scroll', height: '35.8rem', marginLeft: '1.875rem', padding: '0.1875rem', boxShadow: 'rgb(0 0 0) 0 0rem 1rem 0' }} className="w-full overflow-scroll">
                                        <table style={{ width: '469.625rem', padding: '', display: 'block', background: '', borderCollapse: 'collapse' }}>
                                            <thead style={{ fontSize: '2.625rem', letterSpacing: '-0.07rem', background: '#472480', color: '#eeeeee' }}>
                                                <tr style={{ height: '8.925rem', borderBottom: '0.1875rem solid #dddddd' }}>
                                                    <td style={{ width: '13.8125rem', textAlign: 'center', background: '#391d66' }}>구분</td>
                                                    <td style={{ width: '13.8125rem', textAlign: 'center', paddingTop: '0.5rem' }}>스포츠</td>
                                                    <td style={{ width: '13.8125rem', textAlign: 'center', paddingTop: '0.5rem' }}>미니게임</td>
                                                    <td style={{ width: '14.8125rem', textAlign: 'center', paddingTop: '0.5rem', paddingRight: '1rem' }}><span style={{letterSpacing:'-0.24rem'}}>프레그메틱</span><br /><span >플레이</span></td>
                                                    <td style={{ width: '13.8125rem', textAlign: 'center', paddingTop: '0.5rem', paddingRight: '0.5rem' }}>에볼루션</td>
                                                    <td style={{ width: '13.8125rem', textAlign: 'center', paddingTop: '0.5rem', paddingRight: '3rem' }}>로얄지</td>
                                                    <td style={{ width: '13.8125rem', textAlign: 'center', paddingTop: '0.5rem', paddingRight: '2.5rem' }}><span>드림</span><br /><span>게이밍</span></td>
                                                    <td style={{ width: '13.8125rem', textAlign: 'center', paddingTop: '0.5rem', paddingRight: '2.5rem' }}><span>섹시</span><br /><span>게이밍</span></td>
                                                    ...
                                                    <td style={{ width: '13.8125rem', textAlign: 'center', paddingTop: '0.5rem' }} className="text-center h-full flex items-center justify-center">e-스포츠</td>
                                                    <td style={{ width: '13.8125rem', textAlign: 'center', paddingTop: '0.5rem' }}><span>키론</span><br /><span>가상게임</span></td>
                                                    <td style={{ width: '13.8125rem', textAlign: 'center', paddingTop: '0.5rem', background: '#391d66' }}>합계</td>
                                                </tr>
                                            </thead>
                                            <tbody style={{ fontSize: '2.625rem', color: '#666666' }} className="w-full text-585858 text-14px tracking-tight ">
                                                <tr style={{ height: '8.925rem', borderBottomWidth: '0.1875rem', borderBottom: '0.1875rem solid #dddddd', letterSpacing: '-0.07rem', background: '#ffffff', color: '#666666' }} className="flex items-center bg-gray-fefefe  tracking-tight text-gray-r454545 w-full border-b border-gray-dddddd">
                                                ...
                                                <tr style={{ height: '8.625rem', fontSize: '2.625rem', borderBottomWidth: '0.1875rem', borderBottom: '0.1875rem solid #dddddd', background: '#f7f7f7' }} className="flex items-center bg-gray-fefefe  tracking-tight text-gray-r454545 w-full border-b border-gray-dddddd">
                                                    <td style={{ width: '13.8125rem', color: '#666666', textAlign: 'center', background: '#eaeaea' }} className="bg-gray-r7a848f h-full flex items-center justify-center  text-white tracking-tight">승패</td>
                                                    <td style={{ width: '13.8125rem', textAlign: 'right', paddingRight: '0.6rem', paddingBottom: '0.4rem' }} className="text-right">0</td>
                                                    <td style={{ width: '13.8125rem', textAlign: 'right', paddingRight: '0.8rem', paddingBottom: '0.4rem' }} className="text-right">0</td>
                                                    <td style={{ width: '13.8125rem', textAlign: 'right', paddingRight: '0.8rem', paddingBottom: '0.4rem' }} className="text-right">0</td>
                                                    <td style={{ width: '13.8125rem', textAlign: 'right', paddingRight: '0.8rem', paddingBottom: '0.4rem' }} className="text-right">0</td>
                                                    ...
                                                    <td style={{ width: '13.8125rem', textAlign: 'right', paddingRight: '0.8rem', paddingBottom: '0.4rem' }} className="text-right">0</td>
                                                    {/* <td style={{ width: '13.8125rem', textAlign: 'right', paddingRight: '0.8rem', paddingBottom: '0.4rem' }} className="text-right pr-4">0</td> */}
                                                    <td style={{ backgroundColor: "#eaeaea", color: "", width: '13.8125rem', textAlign: 'right', paddingRight: '3.8rem', paddingBottom: '0.2rem' }} className="text-right pr-4 h-full flex items-center justify-end">0</td>
                                                </tr>
                                                <tr style={{ height: '8.925rem', fontSize: '2.625rem', borderBottomWidth: '0.1875rem', background: '#ffffff' }} className="flex items-center bg-gray-fefefe  tracking-tight text-gray-r454545 w-full border-b border-gray-dddddd">
                                                    <td style={{ width: '13.8125rem', color: '#666666', textAlign: 'center', padding: '0.3rem 0 0 0.5rem', background: '#f2f2f2' }} className="bg-gray-r7a848f h-full flex items-center justify-center  text-white tracking-tight">정산금액</td>
                                                    <td style={{ width: '13.8125rem', textAlign: 'right', paddingRight: '0.6rem', paddingBottom: '0rem' }} className="text-right">0</td>
                                                    ...
                                                    <td style={{ width: '13.8125rem', textAlign: 'right', paddingRight: '0.8rem', paddingBottom: '0rem' }} className="text-right">0</td>
                                                    {/* <td style={{ width: '13.8125rem', textAlign: 'right', paddingRight: '0.8rem', paddingBottom: '0rem' }} className="text-right pr-4">0</td> */}
                                                    <td style={{ backgroundColor: "#f2f2f2", color: "", width: '13.8125rem', textAlign: 'right', paddingRight: '3.8rem', paddingBottom: '0.2rem' }} className="text-right pr-4 h-full flex items-center justify-end">0</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                            ...
                            <div style={{ marginLeft: '1.875rem', marginTop: '4.3125rem', marginBottom: '0.75rem', display: 'flex', alignItems: 'center', letterSpacing: '-0.07rem' }} className="w-full flex items-center tracking-tight text-gray-r7b7b7b ">
                                <img style={{ width: '3.1875rem', height: '2.75rem', marginRight: '0.7rem' }} className='object-contain -mt-1.5' src={MemberIcon} alt="" />
                                <div style={{ fontSize: '3rem', color: '#eeeeee', marginTop: '0.1rem' }}>접속중인 회원수 : <span className="tracking-tight text-gray-r454545" style={{ color: '#fdfcfe' }}>2명</span></div>
                                ...
                                <div
                                    style={{
                                        ...
                                        boxShadow: '0px 0.188rem 0.375rem 0px rgba(0, 0, 0, 0.6)',
                                        marginTop: '-0.1rem'
                                    }}
                                ...
                                >
                                    ...
                                    >
                                        <span style={{
                                            fontSize: '2.625rem', color: '#ffffff',
                                            marginTop: '0.2rem',
                                            marginLeft: '-0.1rem',
                            ...
                            {viewOnline && (
                                <div style={{ marginLeft: '1.875rem', display: 'flex', position: 'relative' }} className='flex relative'>
                                    ...
                                    <div style={{ width: '75.75rem', height: "9rem", padding: '0 1.225rem', borderRadius: '4.25rem', borderTopRightRadius: '0', borderBottomRightRadius: '0', borderRightWidth: '0', display: 'flex', position: 'relative', alignItems: 'center', overflow: 'scroll', background: "linear-gradient(to right, #672f8c, #351e79" }} className="flex bg-gray-f9f9f9 relative border border-gray-dddddd rounded-2xl items-center overflow-scroll">
                                        <UsersOnline />
                                        <UsersOnline name="tkskdl12" />
                                    </div>
                                </div>
                            )}
                            <div style={{ marginLeft: '1.875rem', marginTop: '4.3rem', fontSize: '3rem', width: '73.875rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', letterSpacing: '-0.07rem' }} className="flex items-end justify-between tracking-tight text-gray-r7b7b7b ">
                                <div className="flex items-center items-center flex" style={{ display: 'flex', alignItems: 'center' }}>
                                    ...
                                    <div className='mt-1' style={{ color: '#eeeeee' }}>추천 회원내역</div>
                                </div>

                                <div style={{ maxWidth: '40.6875rem', height: '5.3125rem', border: '0.188rem solid #9361e5', fontSize: '2.625rem', borderRadius: '2.625rem', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#341d5a', padding: '0 2rem', marginTop: '0.1rem' }}>
                                    <img style={{ width: '1.313rem', height: '1.3125rem', marginRight: '0.9rem' }} src={Diamond1} alt="" />
                                    <div style={{ marginTop: '0.15rem' }}>
                            ...
                            <div className='flex relative div-shadow' style={{
                                marginLeft: '1.8125rem', color: '#c8c8c8', 
                                padding: '0.1875rem',
                                borderTopLeftRadius: '0.4rem',
                                borderBottomLeftRadius: '0.4rem',
                                background: 'linear-gradient(to top, rgb(238, 238, 238), rgb(147, 98, 229))',
                                boxShadow: 'rgb(0 0 0) 0px 0rem 1rem 0px',
                                marginTop: '0.375rem',
                            }}>
                                <div style={{ padding: '0', width: '114.75rem', background: 'red' }}>
                                    <div style={{ width: '75.625rem', borderRightWidth: '0', display: 'flex', flexDirection: 'column', overflow: 'scroll', background: '#eeeeee' }}>
                                        <div style={{ width: '290.125rem', padding: '', display: 'flex', flexDirection: 'column', fontSize: '2.625rem' }}>
                                            <div style={{ height: '8.9625rem', fontSize: '2.625rem', background: '#472480', padding: '0px 1.875rem', borderBottom: '0.1875rem solid #acacac', display: 'flex', alignItems: 'center', color: '#eeeeee', letterSpacing: '-0.07rem'
                                 }}>
                                                <div style={{ width: '13rem', paddingLeft: '2.6rem', textAlign: '', paddingTop: '0.6rem' }}>번호</div>
                                                <button
                                                    style={{ padding: '0', margin: '0', background: 'bottom', width: '21.7rem', letterSpacing: '-0.07rem', paddingTop: '0.7rem', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', textAlign: 'center' }}
                                                ...
                                                >
                                                    <p style={{ color: '#eeeeee', fontSize: '2.625rem' }}>아이디</p>
                                                    <img style={{ width: '1.9375rem', height: '1.3125rem', marginLeft: '0.4375rem', transform: isArrowUp[0] === true ? "rotate(180deg)" : "" }} src={WhiteArrow1} className={`${isArrowUp[0] === true ? "transform rotate-180" : ""}`} alt="" />
                                                </button>
                                                ...
                                                >
                                                    ...
                                                    <img style={{ width: '1.9375rem', height: '1.3125rem', marginLeft: '0.4375rem', transform: isArrowUp[1] === false ? "rotate(180deg)" : "" }} src={WhiteArrow1} className={`${isArrowUp[1] === false ? "transform rotate-180" : ""}`} alt="" />
                                                </button>
                                                <button
                                                    style={{ width: '18rem', height: '100%', fontSize: '2.4rem', textAlign: 'center', background: 'bottom', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
                                                    className="text-center flex items-center justify-center hover:opacity-75 "
                                                ...
                                                >
                                                    ...
                                                    <img style={{ width: '1.9375rem', height: '1.3125rem', marginLeft: '0.4375rem', fontSize: '2.4rem', transform: isArrowUp[2] === false ? "rotate(180deg)" : "" }} src={WhiteArrow1} className={`${isArrowUp[2] === false ? "transform rotate-180" : ""}`} alt="" />
                                                </button>
                                                <div style={{ width: '18rem', textAlign: 'center' }}>요율보기</div>
                                                <div style={{ width: '18rem', textAlign: 'center' }} className="text-center -mt-3.5">입금액</div>
                                                <div style={{ width: '18rem', textAlign: 'center' }} className="text-center -mt-3.5">보너스</div>
                                                ...
                                                >
                                                    <p style={{ color: '#eeeeee', fontSize: '2.625rem' }}>출금액</p>
                                                    <img style={{ width: '1.9375rem', height: '1.3125rem', marginLeft: '0.4375rem', transform: isArrowUp[3] === false ? "rotate(180deg)" : "" }} src={WhiteArrow1} className={`${isArrowUp[3] === false ? "transform rotate-180" : ""}`} alt="" />
                                                </button>
                                                <div style={{ padding: '0', margin: '0', background: 'bottom', width: '18rem', textAlign: 'center' }}>입출금액</div>
                                                <button
                                                    style={{ padding: '0', margin: '0', background: 'bottom', width: '18rem', height: '100%', display: 'flex', textAlign: 'center', alignItems: 'center', justifyContent: 'center' }}
                                                ...
                                                >
                                                    <p style={{ color: '#eeeeee', fontSize: '2.625rem' }}>베팅액</p>
                                                    <img style={{ width: '1.9375rem', height: '1.3125rem', marginLeft: '0.4375rem', transform: isArrowUp[4] === false ? "rotate(180deg)" : "" }} src={WhiteArrow1} className={`${isArrowUp[4] === false ? "transform rotate-180" : ""}`} alt="" />
                                                </button>
                                                <button
                                                    style={{ padding: '0', margin: '0', background: 'bottom', width: '18rem', display: 'flex', height: '100%', textAlign: 'center', alignItems: 'center', justifyContent: 'center' }}
                                                    className="flex text-center items-center justify-center hover:opacity-75"
                                                ...
                                                >
                                                    <p style={{ color: '#eeeeee', fontSize: '2.625rem' }}>윈루즈</p>
                                                    <img style={{ width: '1.9375rem', height: '1.3125rem', marginLeft: '0.4375rem', transform: isArrowUp[5] === false ? "rotate(180deg)" : "" }} src={WhiteArrow1} className={`${isArrowUp[5] === false ? "transform rotate-180" : ""}`} alt="" />
                                                </button>
                                                <div style={{ width: '18rem', textAlign: 'center' }}>상세내역</div>
                                                <button
                                                    style={{ padding: '0', margin: '0', background: 'bottom', width: '18rem', height: '100%', display: 'flex', textAlign: 'center', alignItems: 'center', justifyContent: 'center' }}
                                                ...
                                                >
                                                    <p style={{ color: '#eeeeee', fontSize: '2.625rem' }}>포인트</p>
                                                    <img style={{ width: '1.9375rem', height: '1.3125rem', marginLeft: '0.4375rem', transform: isArrowUp[6] === false ? "rotate(180deg)" : "" }} src={WhiteArrow1} className={`${isArrowUp[6] === false ? "transform rotate-180" : ""}`} alt="" />
                                                </button>
                                                <button
                                                    style={{ padding: '0', margin: '0', background: 'bottom', width: '18rem', height: '100%', display: 'flex', textAlign: 'center', alignItems: 'center', justifyContent: 'center' }}
                                                    className="text-center flex items-center justify-center hover:opacity-75"
                                                ...
                                                >
                                                    ...
                                                    <img style={{ width: '1.9375rem', height: '1.3125rem', marginLeft: '0.4375rem', transform: isArrowUp[7] === false ? "rotate(180deg)" : "" }} src={WhiteArrow1} className={`${isArrowUp[7] === false ? "transform rotate-180" : ""}`} alt="" />
                                                </button>
                                            </div>
