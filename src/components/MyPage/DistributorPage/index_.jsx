...
const DistributorPage = ({
  ...
  const SummaryCard = ({ text1, text2, img, count }) => (
    <div
      style={{
        ...
        boxShadow: '0px 2px 2px 0px rgba(0, 0, 0, 0.6)',
      }}
    >
      <div
        style={{
              ...
              >
                ...
                <td>
                  ...
                  >
                    ...
                    >
                      <span
                        className="small-padding shadow-to-text"
                        style={{ color: '#ffffff' }}
                      >
                        수정
                      </span>
      ...
      <div>
        ...
        >
          ...
          >
            ...
            <tbody
              style={{ fontSize: '2.625rem', color: '#666666' }}
            ...
            >
              ...
              >
                <td
                  ...
                  className="bg-gray-r7a848f h-full flex items-center justify-center  text-white tracking-tight"
                >
                  베팅금
                </td>
                <td
                ...
                <td
                  ...
                  className="text-right pr-4 h-full flex items-center justify-end"
                >
                  7.14M
                </td>
              </tr>
    ...
    return items.map((item) => (
      <>
        <div
          ...
          className={`${item.id % 2 === 1 ? 'bg-white' : 'bg-gray-f8f9fb'} ${
            item.isLast ? 'border-b' : 'border-b'
          } w-full flex items-center justify-evenly font-roboto text-gray-r585858 tracking-tight border-l border-r border-gray-dddddd`}
        >
          <div
          ...
          >
            {item.user_count === 0 ? (
              ...
              <button
                ...
                className={`${
                  isUserCountOpen ? 'bg-blue-r0070d9' : 'bg-blue-r2068b2'
                } hover flex items-center justify-center rounded-lg hover:opacity-75`}
                onClick={() => {
            ...
            {isUserCountOpen[item.id] === true && (
              ...
              >
                <img
                  style={{ width: '3.111875rem', height: 'auto' }}
          ...
          <div
            className="test relative w-full h-full flex items-center justify-center"
            style={{
              width: '18rem',
              height: '100%',
              display: 'flex',
              ...
              marginLeft: '',
              marginRight: '-0.1rem',
              paddingLeft: withPadding ? '2.5rem' : '5.1rem',
            }}
          >
            <button
              style={{
              ...
              className={`${
                isUserCountOpen ? 'bg-blue-r0070d9' : 'bg-blue-r2068b2'
              } hover flex items-center justify-center rounded-lg hover:opacity-75 shadow-to-box shadow-to-text`}
              onClick={() => {
          ...
          <div
            className="w-full h-full flex items-center justify-end text-right"
            style={{
              width: '18rem',
              height: '100%',
              display: 'flex',
          ...
          >
            <p className="pr-32px">{item.added_amount}</p>
          </div>
          <div
            className="w-full h-full flex items-center justify-end text-right"
            style={{
          ...
          >
            <p className="pr-32px">{item.bonus}</p>
          </div>
          <div
            className="w-full h-full flex items-center justify-end text-right"
            style={{
          ...
          >
            <p className="pr-32px">{item.withdraw_amount}</p>
          </div>
          <div
            className="w-full h-full flex items-center justify-end text-right"
            style={{
          ...
          >
            <p className="pr-32px">{item.added_withdraw_amount}</p>
          </div>
          <div
            className="w-full h-full flex items-center justify-end text-right"
            style={{
          ...
          >
            <p className="pr-32px">{item.bet_amount}</p>
          </div>
          <div
            className="w-full h-full flex items-center justify-end text-right"
            style={{
          ...
          >
            <p className="pr-32px">{item.win_lose}</p>
          </div>
          <div
            className="relative w-full h-full flex items-center justify-center"
            style={{
            ...
            {isUserCountOpen[item.id + 2] === true && (
              <div
                ...
                style={{
                  position: 'absolute',
                  bottom: '-1rem',
                  left: items === RecommendedUserArray2 && '11.5rem',
                }}
              >
                <img
                  style={{ width: '3.111875rem', height: 'auto' }}
          ...
          >
            <p className="pr-32px">{item.point}</p>
          </div>
          <div
            className="w-full h-full flex items-center justify-end"
            style={{
          ...
          >
            <p className="pr-32px">{item.holding_amount}</p>
          </div>
        </div>
        <div
          style={{
                ...
                >
                  <div
                    style={{
                      ...
                      fontSize: '2.625rem',
                      background: '#5d4386',
                      padding: !withPadding ? '0' : '0px 1.875rem',
                      borderBottomWidth: '0.1875rem',
                      display: 'flex',
                      alignItems: 'center',
                      color: '#eeeeee',
                    ...
                    >
                      ...
                      <img
                        style={{
                          ...
                          marginLeft: '0.4375rem',
                          transform:
                            subArrowClicked[0] === true ? 'rotate(180deg)' : '',
                        }}
                        src={WhiteArrow1}
                        className={`${
  ...
  return (
    <div className="relative flex flex-col h-full">
      <HomePageTopBanner
        pageTitle="총판페이지"
        toPath="/mypage/distributor-page"
      />
      <div
        style={{
          margin: '0',
      ...
      >
        ...
        <div
          ...
          className="relative flex flex-col justify-start limit:justify-center"
        >
          <div className="flex flex-col items-start w-full h-full">
            <div className="w-1836px">
              <div
                ...
                className="w-full flex items-center tracking-tight text-gray-r7b7b7b "
              >
                <img
                  style={{
                    width: '3.063rem',
              ...
              <div
                className="flex relative div-shadow"
                ...
                >
                  <div
                    style={{
                      width: '75.925rem',
                      overflowX: 'scroll',
                      background: 'linear-gradient(to top, #eeeeee, #9362e5)',
                      padding: '0.1875rem',
                      margin: '0 1.7rem',
                      boxShadow: '0 0rem 1rem 0 #000',
                  ...
                  >
                    ...
                    >
                      <thead
                        style={{ height: '8.75rem', color: '#eeeeee' }}
                        className="w-full border-b border-gray-dddddd bg-gray-r8e9296  text-16px text-white tracking-tight"
                      >
                        <tr
                          style={{
                            height: '8.75rem',
              ...
              <div
                ...
                className="relative w-full flex flex-col justify-center overflow-visible DistributorPage"
              >
                <DateSearchBar
                  withMargin={false}
                  isLeagueSearch={false}
                  withBlackButton
                  isDistributorPage={true}
                />
              </div>
                ...
                <div style={{ padding: '0', width: '114.75rem' }}>
                  <div
                    style={{
                      ...
                      marginLeft: '1.875rem',
                      padding: '0.1875rem',
                      boxShadow: 'rgb(0 0 0) 0 0rem 1rem 0',
                    }}
                    className="w-full overflow-scroll"
                  >
                    <table
              ...
              >
                ...
                >
                  접속중인 회원수 :{' '}
                  <span
                    className="tracking-tight text-gray-r454545"
                    style={{ color: '#fdfcfe' }}
                  >
                    2명
                  </span>
              ...
              {viewOnline && (
                ...
                >
                  <div
                    style={{
                      boxShadow: '0rem 0 3rem 2.5rem #5423a0',
                      width: '0',
                      top: '0',
                      right: '0',
                      position: 'absolute',
                  ...
                  <div
                    style={{
                      ...
                      alignItems: 'center',
                      overflow: 'scroll',
                      background: 'linear-gradient(to right, #672f8c, #351e79',
                    }}
                    className="flex bg-gray-f9f9f9 relative border border-gray-dddddd rounded-2xl items-center overflow-scroll"
                  >
                    <UsersOnline />
              ...
              <div
                ...
                className="flex items-end justify-between tracking-tight text-gray-r7b7b7b "
              >
                <div
                  className="flex items-center items-center flex"
                  style={{ display: 'flex', alignItems: 'center' }}
                >
                  <img
                    style={{
                      width: '3.1875rem',
                      height: '2.9375rem',
                      marginRight: '0.7125rem',
                    }}
                    className="object-contain -mt-1.5"
                    src={RecommendIcon}
                    alt=""
                  />
                  <div className="mt-1" style={{ color: '#eeeeee' }}>
                    추천 회원내역
                  </div>
                </div>
              ...
              <div
                ...
                style={{
                  ...
                  borderBottomLeftRadius: '0.4rem',
                  background:
                    'linear-gradient(to top, rgb(238, 238, 238), rgb(147, 98, 229))',
                    ...
                    >
                      <div
                        style={{
                          ...
                          borderBottom: '0.1875rem solid #acacac',
                          display: 'flex',
                          alignItems: 'center',
                          color: '#eeeeee',
                          letterSpacing: '-0.07rem',
                        ...
                        >
                          ...
                          <img
                            style={{
                              ...
                              marginLeft: '0.4375rem',
                              transform:
                                isArrowUp[0] === true ? 'rotate(180deg)' : '',
                            }}
                            src={WhiteArrow1}
                            className={`${
                              isArrowUp[0] === true
                        ...
                        >
                          ...
                          <img
                            style={{
                              ...
                              marginLeft: '0.4375rem',
                              transform:
                                isArrowUp[1] === false ? 'rotate(180deg)' : '',
                            }}
                            src={WhiteArrow1}
                            className={`${
                              isArrowUp[1] === false
                        ...
                        >
                          ...
                          <img
                            style={{
                              ...
                              fontSize: '2.4rem',
                              transform:
                                isArrowUp[2] === false ? 'rotate(180deg)' : '',
                            }}
                            src={WhiteArrow1}
                            className={`${
                              isArrowUp[2] === false
                        ...
                        >
                          ...
                          <img
                            style={{
                              ...
                              marginLeft: '0.4375rem',
                              transform:
                                isArrowUp[3] === false ? 'rotate(180deg)' : '',
                            }}
                            src={WhiteArrow1}
                            className={`${
                              isArrowUp[3] === false
                        ...
                        >
                          ...
                          <img
                            style={{
                              ...
                              marginLeft: '0.4375rem',
                              transform:
                                isArrowUp[4] === false ? 'rotate(180deg)' : '',
                            }}
                            src={WhiteArrow1}
                            className={`${
                              isArrowUp[4] === false
                        ...
                        >
                          ...
                          <img
                            style={{
                              ...
                              marginLeft: '0.4375rem',
                              transform:
                                isArrowUp[5] === false ? 'rotate(180deg)' : '',
                            }}
                            src={WhiteArrow1}
                            className={`${
                              isArrowUp[5] === false
                        ...
                        >
                          ...
                          <img
                            style={{
                              ...
                              marginLeft: '0.4375rem',
                              transform:
                                isArrowUp[6] === false ? 'rotate(180deg)' : '',
                            }}
                            src={WhiteArrow1}
                            className={`${
                              isArrowUp[6] === false
                        ...
                        >
                          ...
                          <img
                            style={{
                              ...
                              marginLeft: '0.4375rem',
                              transform:
                                isArrowUp[7] === false ? 'rotate(180deg)' : '',
                            }}
                            src={WhiteArrow1}
                            className={`${
                              isArrowUp[7] === false
            ...
            <div
              style={{ marginTop: '3.75rem', paddingBottom: '0.01rem' }}
