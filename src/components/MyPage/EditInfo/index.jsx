    ...
    return (
        <div className="edit-info">
            ...
            <div className="edit-info-content" >
                    ...
                    <div className="border">
                        ...
                        <div style={{ marginTop: '1.5rem' }} className="flex flex-wrap">
                            <div className='form-section'>
                                <Title text="비밀번호" />
                                <div className="lable-or-input"
                                    style={{ borderBottom: selectedInput === 1 ? '0.375rem solid #682aa7' : 'unset' }}
                            ...
                            <span style={{ letterSpacing: isMobile && "-0.31rem" }} className="text-under-input">최소 6~16자 내외로 입력해주세요.</span>
                            <span style={{ letterSpacing: isMobile && "-0.31rem" }} className="text-under-input1">(알파벳 소문자 + 특수문자 포함)</span>
                        </div>
                        ...
                        <div style={{ marginTop: '1.2rem' }} className="flex flex-wrap">
                            <div className='form-section'>
                                <Title text="비밀번호 확인" />
                                <div className="lable-or-input"
                                    style={{ borderBottom: selectedInput === 2 ? '0.375rem solid #682aa7' : 'unset' }}
                        ...
                        <div style={{ marginTop: '1.5rem' }} className="flex flex-wrap">
                            <div className='form-section'>
                                <Title text="환전비밀번호" />
                                <div className="lable-or-input"
                                    style={{ borderBottom: selectedInput === 3 ? '0.375rem solid #682aa7' : 'unset' }}
                        ...
                        <div style={{ marginTop: '1rem' }} className="flex flex-wrap">
                            <div className='form-section'>
                                ...
                                <div className="lable-or-input"
                                    style={{ borderBottom: selectedInput === 4 ? '0.375rem solid #682aa7' : 'unset' }}
                ...
                <div className='button-class-div shadow-box-myPage hover'>
                    <button style={{
                        display: 'flex',
                        alignItems: 'center',
