    ...
    return (
        <div className="WarningMessageClass">
            ...
            <div className="alert-messages">
                ...
                {message2 &&
                    <div style={{ alignItems: 'flex-start', marginRight: isExchange ? '10rem' : '10.5rem' }} className="next-span">
                        <span style={{ color: '#666666' }} className='correct'>✓</span>
                        <span style={{ marginTop: '0' , color: '#666666'}}>{message2} {message2_1}</span>
                    </div>
                }
                {message3 &&
                    <div style={{ alignItems: 'flex-start', marginRight: isExchange ? '0' : '10.5rem' }} className="next-span">
                        <span style={{ color: '#666666' }} className='correct'>✓</span>
