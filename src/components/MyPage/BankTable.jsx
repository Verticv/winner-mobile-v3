        ...
        <div style={{ marginTop: '1.838rem', background: 'linear-gradient(to top, #ededeb , #cb78e6)', padding: '0.1875rem', borderRadius: '1.125rem', boxShadow: "0px 0px 12px 0px rgba(0, 0, 0, 0.8)" }}>
            <div style={{ display: 'flex', height: '13.5rem', background: '#ffffff', borderTopLeftRadius: "1.125rem", borderTopRightRadius: "1.125rem" }}>
                <div style={{ width: '50%', textAlign: 'center', borderRight: '0.1875rem solid #dddddd' }}>
                    ...
                    <p style={{ margin: '-1.5rem 0 0 -0rem', color: '#666666', fontSize: '2.25rem', fontFamily: 'SpoqaHanSansNeo', letterSpacing: '-0.05rem' }}>00:00 ~00:20</p>
                </div>
                <div style={{ width: '50%', textAlign: 'center' }}>
                    ...
                    <p style={{ margin: '-1.5rem 0 0 -0rem', color: '#666666', fontSize: '2.25rem', fontFamily: 'SpoqaHanSansNeo', letterSpacing: '-0.05rem' }}>11:50 ~01:00
                    </p>
                </div>
            </div>
            <div style={{ display: 'flex', height: '13.7rem', background: '#f7f7f7', borderTop: '0.1875rem solid #dddddd' }}>
                ...
                <div style={{ width: '50%', textAlign: 'center' }}>
                    ...
                    <p style={{ margin: '-1.5rem 0 0 -0rem', color: '#666666', fontSize: '2.25rem', fontFamily: 'SpoqaHanSansNeo', letterSpacing: '-0.05rem' }}>04:00 ~05:00
                    </p>
                </div>
            </div>
            <div style={{ display: 'flex', height: '13.737rem', background: '#ffffff', borderTop: '0.1875rem solid #dddddd' }}>
                <div style={{ width: '50%', textAlign: 'center', borderRight: '0.1875rem solid #dddddd' }}>
                    ...
                    <p style={{ margin: '-1.5rem 0 0 -0rem', color: '#666666', fontSize: '2.25rem', fontFamily: 'SpoqaHanSansNeo', letterSpacing: '-0.05rem' }}>00:00 ~00:10</p>
                </div>
                <div style={{ width: '50%', textAlign: 'center' }}>
                    <div style={{ height: '10rem', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                        <img src={Bank6} alt="" style={{ width: '20.688rem' }} />
                    </div>
                    <p style={{ margin: '-1.5rem 0 0 -0rem', color: '#666666', fontSize: '2.25rem', fontFamily: 'SpoqaHanSansNeo', letterSpacing: '-0.05rem' }}>00:00 ~00:20
                    </p>
                </div>
            </div>
            <div style={{ display: 'flex', height: '13.7rem', background: '#f7f7f7', borderTop: '0.1875rem solid #dddddd' }}>
                <div style={{ width: '50%', textAlign: 'center', borderRight: '0.1875rem solid #dddddd' }}>
                    ...
                    <p style={{ margin: '-1.5rem 0 0 -0rem', color: '#666666', fontSize: '2.25rem', fontFamily: 'SpoqaHanSansNeo', letterSpacing: '-0.05rem' }}>23:50 ~00:30</p>
                </div>
                <div style={{ width: '50%', textAlign: 'center' }}>
                    <div style={{ height: '10rem', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                        <img src={Bank8} alt="" style={{ marginTop: '-1.7rem', width: '15.5rem' }} />
                    </div>
                    <p style={{ margin: '-1.5rem 0 0 -0rem', color: '#666666', fontSize: '2.25rem', fontFamily: 'SpoqaHanSansNeo', letterSpacing: '-0.05rem' }}>23:40 ~00:05
                    </p>
                </div>
            </div>
            <div style={{ display: 'flex', height: '13.6rem', background: '#ffffff', borderTop: '0.1875rem solid #dddddd' }}>
                ...
                <div style={{ width: '50%', textAlign: 'center' }}>
                    ...
                    <p style={{ margin: '-1.5rem 0 0 -0rem', color: '#666666', fontSize: '2.25rem', fontFamily: 'SpoqaHanSansNeo', letterSpacing: '-0.05rem' }}>00:00 ~00:10
                    </p>
                </div>
            </div>
            <div style={{ display: 'flex', height: '13.7rem', background: '#f7f7f7', borderTop: '0.1875rem solid #dddddd' }}>
                <div style={{ width: '50%', textAlign: 'center', borderRight: '0.1875rem solid #dddddd' }}>
                    ...
                    <p style={{ margin: '-1.5rem 0 0 -0rem', color: '#666666', fontSize: '2.25rem', fontFamily: 'SpoqaHanSansNeo', letterSpacing: '-0.05rem' }}>23:55 ~00:10</p>
                </div>
                <div style={{ width: '50%', textAlign: 'center' }}>
                    <div style={{ height: '10rem', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            ...
            <div style={{ display: 'flex', height: '13.7rem', background: '#ffffff', borderTop: '0.1875rem solid #dddddd' }}>
                <div style={{ width: '50%', textAlign: 'center', borderRight: '0.1875rem solid #dddddd' }}>
                    ...
                    <p style={{ margin: '-1.5rem 0 0 -0rem', color: '#666666', fontSize: '2.25rem', fontFamily: 'SpoqaHanSansNeo', letterSpacing: '-0.05rem' }}>23:50 ~01:00</p>
                </div>
                <div style={{ width: '50%', textAlign: 'center' }}>
                    <div style={{ height: '10rem', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            ...
            <div style={{ display: 'flex', height: '13.7rem', background: '#f7f7f7', borderTop: '0.1875rem solid #dddddd' }}>
                ...
                <div style={{ width: '50%', textAlign: 'center' }}>
                    ...
                    <p style={{ margin: '-2rem 0 0 -0rem', color: '#666666', fontSize: '2.25rem', fontFamily: 'SpoqaHanSansNeo', letterSpacing: '-0.05rem' }}>23:50 ~00:30
                    </p>
                </div>
            </div>
            <div style={{ display: 'flex', height: '13.7rem', background: '#ffffff', borderTop: '0.1875rem solid #dddddd' }}>
            ...
            <div style={{ display: 'flex', height: '13.7rem', background: '#f7f7f7', borderTop: '0.1875rem solid #dddddd' }}>
                ...
                <div style={{ width: '50%', textAlign: 'center' }}>
                    ...
                    <p style={{ margin: '-2rem 0 0 -0rem', color: '#666666', fontSize: '2.25rem', fontFamily: 'SpoqaHanSansNeo', letterSpacing: '-0.05rem' }}>23:55 ~00:35
                    </p>
                </div>
            </div>
            <div style={{ display: 'flex', height: '13.7rem', background: '#ffffff', borderTop: '0.1875rem solid #dddddd' }}>
                <div style={{ width: '50%', textAlign: 'center', borderRight: '0.1875rem solid #dddddd' }}>
                    ...
                    <p style={{ margin: '-1.5rem 0 0 -0rem', color: '#666666', fontSize: '2.25rem', fontFamily: 'SpoqaHanSansNeo', letterSpacing: '-0.05rem' }}>00:05 ~00:20</p>
                </div>
                <div style={{ width: '50%', textAlign: 'center' }}>
                    <div style={{ height: '10rem', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                        <img src={Bank22} alt="" style={{ marginTop: '-0.3rem', marginLeft: '0rem', width: '22.1875rem' }} />
                    </div>
                    <p style={{ margin: '-2rem 0 0 -0rem', color: '#666666', fontSize: '2.25rem', fontFamily: 'SpoqaHanSansNeo', letterSpacing: '-0.05rem' }}>23:50 ~00:05
                    </p>
                </div>
            </div>
            <div style={{ display: 'flex', height: '13.7rem', background: '#f7f7f7', borderTop: '0.1875rem solid #dddddd' }}>
                ...
                <div style={{ width: '50%', textAlign: 'center' }}>
                    ...
                    <p style={{ margin: '-2rem 0 0 -0rem', color: '#666666', fontSize: '2.25rem', fontFamily: 'SpoqaHanSansNeo', letterSpacing: '-0.05rem' }}>00:00 ~00:20
                    </p>
                </div>
            </div>
            <div style={{ display: 'flex', height: '13.7rem', background: '#ffffff', borderTop: '0.1875rem solid #dddddd' }}>
                <div style={{ width: '50%', textAlign: 'center', borderRight: '0.1875rem solid #dddddd' }}>
                    ...
                    <p style={{ margin: '-1.5rem 0 0 -0rem', color: '#666666', fontSize: '2.25rem', fontFamily: 'SpoqaHanSansNeo', letterSpacing: '-0.05rem' }}>00:00 ~00:05</p>
                </div>
                <div style={{ width: '50%', textAlign: 'center' }}>
                    <div style={{ height: '10rem', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            ...
            <div style={{ display: 'flex', height: '13.7rem', background: '#f7f7f7', borderTop: '0.1875rem solid #dddddd' , borderBottomLeftRadius: "1.125rem", borderBottomRightRadius: "1.125rem" }}>
                ...
                <div style={{ width: '50%', textAlign: 'center' }}>
                    ...
                    <p style={{ margin: '-1.6rem 0 0 -0rem', color: '#666666', fontSize: '2.25rem', fontFamily: 'SpoqaHanSansNeo', letterSpacing: '-0.05rem' }}>23:50 ~00:30
                    </p>
                </div>
            </div>
        </div>
