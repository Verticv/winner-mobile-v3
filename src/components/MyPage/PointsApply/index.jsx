...
const PointsApply = ({ subActiveButton, setSubActiveButton }) => {
  ...
  return (
    <div
      style={{ padding: '1.875rem', paddingTop: '0.625rem' }}
    ...
    >
      ...
      >
        <div
          style={{
            padding: '0.713rem 1rem 0 0.8rem',
            background: '#ffffff',
            borderRadius: '1.125rem',
          }}
        ...
        >
          ...
          >
            ...
            >
              <span style={{ color: '#ffffff', lineHeight: '1.4' }}>
          ...
          >
            ...
            <div style={{ marginTop: '2.55rem' }} className="form-section">
              ...
              <div
                className="lable-or-input"
                style={{ paddingLeft: '1rem', paddingTop: '1.8rem' }}
              >
                <input
          ...
          >
            <div style={{ marginBottom: '0.963rem' }} className="f-div">
              <div className="div-range-border">
                ...
                >
                  <div
                    style={{ marginTop: '-0.288rem', marginLeft: '0.313rem' }}
                    className="s-div"
                  >
                    <span>1천P</span>
                  </div>
