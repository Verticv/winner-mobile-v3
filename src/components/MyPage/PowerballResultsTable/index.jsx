                ...
                <div
                    ...
                    <div style={{ fontSize: '2.625rem', display: 'flex', alignItems: 'center', color: "#c8c8c8", letterSpacing: '-0.07rem', textAlign: 'center' }} className='w-full h-full flex first-letter:space-x-12 items-center text-gray-585858 '>
                        ...
                        <p
                            ...
                            className="group-hover:text-gray-r7b7b7b text-4xl  text-center flex-shrink-0 leading-tight">{item.num}</p>
                        <p
                            style={{ maxWidth: '15rem', color: "#4c98ff", fontSize: '2.625rem', marginLeft: "9.2rem", textAlign: 'center' }}
                            className="text-4xl  text-center flex-shrink-0 leading-tight">{item.results}</p>
                        <p
                            style={{ maxWidth: '20rem', fontSize: '2.625rem', marginLeft: "8.8rem" }}
                            className="group-hover:text-gray-r7b7b7b text-4xl  text-center flex-shrink-0 leading-tight">{item.ratio}</p>
                    </div>
