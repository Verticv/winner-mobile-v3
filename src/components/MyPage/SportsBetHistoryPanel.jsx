...
const SportsBetHistoryPanel = ({
    ...
    return (
        <>
            <div style={{ background: 'linear-gradient(to top,#ededeb, #cb78e6 )', boxShadow: '0px 0px 8px 0px rgba(0, 0, 0, 0.6)', padding: '0.187rem', borderRadius: '1.1rem' }}>
                <div style={{ marginLeft: "0.063rem", borderRadius: "1em", paddingBottom: '0.5625rem', color: '#ccc2b6', fontFamily: 'SpoqaHanSansNeoMedium', background: '#ffffff' }} className="shadow-subNavbar bg-gray-fafafa">
                    <TableHeader />
            ...
            <div style={{ background: 'linear-gradient(to top,#ededeb, #cb78e6 )', boxShadow: '0px 0px 8px 0px rgba(0, 0, 0, 0.6)', padding: '0.1875rem', borderRadius: '1.3rem', marginTop: '2.1rem' }}>
                <div style={{ borderRadius: "1em", paddingBottom: '0.5625rem', color: '#ccc2b6', fontFamily: 'SpoqaHanSansNeoMedium', background: '#ffffff' }} className="shadow-subNavbar bg-gray-fafafa">
                    <TableHeader />
                    <div style={{ padding: '0rem 0.9rem 0 0.7rem' }} className="w-full">
                        <div className="w-full rounded-lg">
                            <div className='rounded-lg w-full shadow-to-box' style={{ border: '0.45rem solid #6852a7', borderRadius: '0.4rem' }}>
