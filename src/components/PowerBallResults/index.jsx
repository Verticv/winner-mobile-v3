    ...
    return items.map((item) => (
      <div
        style={{
          ...
          fontSize: '2.25rem',
          paddingTop: '0.4rem',
          backgroundColor: item.count % 2 === 0 ? '#ffffff' : '#f7f7f7',
        }}
        className="powerballresult-content7"
      >
        <div
          style={{ width: '10.875rem', paddingRight: '0.3rem' }}
          className="powerballresult-content8"
        >
          <div className="powerballresult-content9">
            <p>{item.count}</p>
            <p>{item.powerball}</p>
          </div>
        </div>
        <div
          style={{ width: '20.0625rem' }}
          className="powerballresult-content8"
        >
          <div className="powerballresult-content9">
            <p>{item.chosenNum}</p>
            <p style={{ color: '#4c98ff' }}>
              {item.powerballOdd ? '홀' : '짝'}
            </p>
          </div>
        </div>
        <div
          style={{ width: '20.0625rem', paddingLeft: '0.5rem' }}
          className="powerballresult-content8"
        >
          <div className="powerballresult-content9">
            <p>{item.numberSum}</p>
        ...
        >
          <div className="powerballresult-content9">
            <p>{item.odd ? '홀' : '짝'}</p>
            <p className="powerballresult-content10">{item.range}</p>
          </div>
        </div>
    ...
    <div className="powerballresult-container">
      <div className="powerballresult-content">
        <div
          ...
          className="powerballresult-content1"
        >
          <div
            style={{ marginBottom: '0.1875rem' }}
            className="powerballresult-content2"
          >
            <div
              style={{
                width: '10.875rem',
              ...
              className="powerballresult-content3"
            >
              회차
            </div>
            <div
          ...
          <div className="powerballresult-content4">
            <div
              ...
              className="powerballresult-content5"
            >
              파워볼
            </div>
            <div
