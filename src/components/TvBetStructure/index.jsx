...
const TvBetStructure = () => {
    ...
    >
      ...
      >
        ...
        <span
          ...
          style={{ color: '#444444', fontWeight: '700' }}
        >
          {title}
        </span>
      </div>
  ...
  const LongItem = ({
    ...
    >
      ...
      >
        ...
        <span className="text-gray-r585858" style={{ color: '#444444', fontWeight: '700' }}>
          {title}
        </span>
      </div>
  ...
  const LongItem2 = ({
    ...
    >
      ...
      >
        <span
          className="text-blue-r0056a6"
          style={{ color: '#444444', marginRight: '0.4rem', fontWeight: '700' }}
        >
          {number}
        </span>
        <span className="text-gray-r585858" style={{ color: '#444444', fontWeight: '700' }}>
  ...
  return (
    <div
      ...
      className="w-full bg-gray-fafafa border border-gray-dddddd p-30px space-y-30px"
    >
      <div
        ...
        >
          ...
          >
            <LongItem
              ...
              text2="플레이방법 : 게임별 이용방법 및 규정 확인 가능"
              text3="게임 : 딜러영상 및 배당판을 제공하며 실제 베팅 가능"
            ...
            <Item
              ...
              text2="전체/기본화면설정, 영상화질설정 등 제공합니다."
              marginTop="1.5rem"
            />
          </div>
        </div>
        ...
        >
          ...
          >
            ...
            <Item
              number="3."
              title="이벤트정보"
              text="현재 라이브 중인 게임과 예정된 게임이벤트를"
              text2="확인할 수 있습니다. 원하는 이벤트를 선택하면"
              text3="배당판이 활성화되며 배당을 선택하면"
              text4="베팅이 가능합니다."
              marginTop="1.5rem"
              isflex
            />
            <Item
              number="4."
              title="베팅기록"
              text="진행중인 베팅 및 베팅 결과를 확인할 수 있습니다."
              marginTop="1.5rem"
            />
            <Item
              number="5."
              title="최근결과"
              text="최근 게임 결과정보를 확인할 수 있습니다."
              marginTop="1.5rem"
            />
            <Item
              number="6."
              title="최근우승"
              text="최근 게임 우승자의 승리금액을 확인할 수 있습니다."
              marginTop="1.5rem"
            />
            <Item
              number="7."
              title="베팅슬립 버튼"
              text="버튼을 누르면 베팅슬립이 나타납니다."
              marginTop="1.5rem"
            />
          </div>
        </div>
