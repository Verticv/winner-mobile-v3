...
import ClockIcon from '../../assets/minigames/clock_white.png';
import RefrshIcon from '../../assets/minigames/refresh_icon.png';
import CloseIcon from '../../assets/minigames/close_icon.png';
...
const MinigamesRightPanel = ({
  ...
  const BetAmountButton = ({ amount }) => (
    <div
      style={{
        ...
        height: '7.5rem',
        background:
          buttonClicked === amount
            ? 'linear-gradient(to top, #886dbf, #ba9ede 50%, #efd2fe)'
            : 'linear-gradient(to top, #886dbf, #ba9ede 50%, #efd2fe)',
        borderRadius: '0.5rem',
        padding: '0.1875rem',
      }}
    ...
    >
      <button
        style={{
          ...
          background:
            buttonClicked === amount
              ? 'linear-gradient(to top, #d8c9fd 0%, #f9d6f6 100%)'
              : 'linear-gradient(to top, #d8c9fd 0%, #f9d6f6 100%)',
          borderRadius: '0.5rem',
        }}
        className="btn-style"
      ...
      >
        <div
          ...
          className="divstyle"
        >
          <span className="spanstyle" style={{color: '#444444', fontWeight: '500'}}>{nf.format(amount)}</span>
        </div>
      </button>
    </div>
  );
  ...
  const BetFixedAmountButton = ({ amount, text }) => (
    <div
      style={{
        ...
        padding: '0.1875rem',
        borderRadius: '0.5rem',
        background: 'linear-gradient(to top, rgb(85, 61, 132), rgb(159, 90, 245) 50%, rgb(196, 115, 236))',
      }}
      className="hover"
    >
      <button
        style={{
          ...
          borderColor: '#171a1d',
          borderRadius: '0.5rem',
          background: 'linear-gradient(to top, rgb(73, 31, 156) 0%, rgb(158, 60, 188) 100%)',
      ...
      >
        ...
        >
          <span className="spancontentstyle shadow-text-myPage" style={{color:'#ffffff'}}>{text}</span>
        </div>
      </button>
    </div>
  );
  ...
  const GrayButton = ({ text }) => (
    <div
      style={{
        width: '36.775rem',
        height: '7.5rem',
        background: 'linear-gradient(to top, #886dbf, #ba9ede 50%, #efd2fe)',
        borderRadius: '1rem',
        padding: '0.1875rem',
        zIndex: '200',
      }}
    ...
    >
      <button
        style={{
          background: 'linear-gradient(to top, #d8c9fd 0%, #f9d6f6 100%)',
          width: '100%',
          height: '100%',
          fontSize: '2.625rem',
          borderRadius: '1rem',
  ...
  const AttachButton = <GrayButton text="회차결과" />;
  ...
  return (
    <div className="container-RP w-fill">
        ...
        >
          ...
          >
            <div style={{ display: 'flex' }}>
              ...
              >
                {format(time, dateFormat, { locale: ko })}{' '}
                {format(time, dateFormat1, { locale: ko })}{' '}
                <p
                  style={{ color: '#ffd98b', marginLeft: '0.8125rem' }}
                  className=""
                >
                  {' '}
                  [216회차]
              ...
              >
                <img
                  ...
                  alt=""
                />
                <p className="content-RP6" style={{ color: '#ffffff' }}>
                  {/* {format(time, dateFormat1, { locale: ko })} */}
                  02:16
                </p>
              </div>
            ...
            <div>
              <div
                className="content-RP7"
                style={{ display: 'flex', marginRight: '0.5rem', marginTop: '0.3rem' }}
              >
                <div
                  className="hover"
                ...
                <button
                  className="hover"
                  onPointerUp={() => setOpenedCart(false)}
                  style={{
                    width: '8rem',
                    height: '8rem',
                    marginLeft: '-0.5rem',
      ...
      <div className="rightpanel-container">
          ...
          <div style={{ height: '11.6875rem' }} className="rightpanel-content1">
            ...
            >
              ...
              <div
                ...
                className="rightpanel-content6"
              >
                {(selectedOption[0].type === '일반볼' ||
                  selectedOption[0].type === '파워볼') && (
                  <p
                    style={{ color: '#666666', fontSize: '2.3rem' }}
                    className="rightpanel-content7"
                  >
                    {selectedOption[0].type}
                  </p>
                )}
                {selectedOption[0].type === '일반볼' ||
                selectedOption[0].type === '파워볼' ? (
                  <p
                    style={{ color: '#5e399a', fontSize: '2.7rem' }}
                    className="rightpanel-content8"
                  >
              ...
              <div
                style={{ width: '16rem', marginTop: '-0.4rem' }}
                className="rightpanel-content10"
              >
                  ...
                  >
                    <img
                      style={{
                        paddingTop:
                          ...
                          selectedOption[0].buttonType === 'red_sq'
                            ? '0.2rem'
                            : '',
                    ...
                    <div className="rightpanel-content14 -space-y-5 -mb-2">
                      <p
                        ...
                        className="rightpanel-content15 -mt-1"
                      >
                        {selectedOption[0].selection}
                      </p>
                      {selectedOption[0].subtitle && (
                        <p
                          style={{ fontSize: '1.6rem', zIndex: '10' }}
                          className="rightpanel-content16 betoption-content7"
                        >
                          {selectedOption[0].subtitle}
                        </p>
                      )}
                    ...
                    {selectedOption[0].tailSide && (
                      <div
                        ...
                        className={`${
                          selectedOption[0].tailSide === 'left'
                            ? 'rightpanel-content17'
                            : 'rightpanel-content18'
                        } rightpanel-content19 w-22px h-22px`}
                      >
                        <div
                          style={{ fontSize: '2.0625rem' }}
                          className="rightpanel-content20 text-12px"
                        >
                          {selectedOption[0].tail}
                        </div>
                      </div>
                    )}
                  </div>
        ...
        >
          <p
            className="content-cart1"
            style={{ color: '#444444', fontWeight: '500' }}
          >
            보유금액
          </p>
          <p style={{ fontSize: '2.625rem' }} className="content-cart2">
            3,522,170
          </p>
        </div>
        <div
          ...
          className="content-cart12"
        >
          <p
            className="content-cart13"
            style={{ color: '#444444', fontWeight: '500' }}
          >
            배당률
          </p>
          <p
            style={{ color: '#e9441d', fontWeight: '500' }}
            className="content-cart14"
          >
            1.95
          </p>
        </div>
        <div
          ...
          className="content-cart15"
        >
          <p
            className="content-cart16"
            style={{ color: '#444444', fontWeight: '500' }}
          >
            베팅금액
          </p>
        ...
        <div style={{ marginTop: '3rem' }} className="betamount-btn">
          ...
          >
            ...
            <div
              className="betfixedamount-btn1"
              style={{ width: '24.375rem', height: '7.5rem' }}
            >
          ...
          <div
            style={{
              ...
              padding: '0.1875rem',
              borderRadius: '0.5rem',
              background: 'linear-gradient(to top, #a32463, #fe84b0)',
              marginBottom:'0.4rem'
            }}
            className="shadow-box-myPage hover"
          >
            <button
              style={{
                ...
                fontSize: '3.1875rem',
                borderRadius: '0.5rem',
                background: 'linear-gradient(to top, #a32463, #c02f6e 50%, #df3b7a)',
              }}
            ...
            >
              <div className="div-style flex items-center justify-center">
                ...
                />
                <span
                  style={{ marginLeft: '0.8125rem', color: '#ffffff' }}
                  className="span-style shadow-text-myPage"
                >
                  베팅하기
                </span>
              </div>
        ...
        {(window.location.pathname === '/minigame/speedkino' ||
          window.location.pathname === '/minigame/kinoladder') && (
          <div
            className="div-style-content bg-opacity-70"
            style={{ zIndex: '20' }}
          >
            <div className="div-style-content1">
              <img
                style={{ width: '10.4375rem' }}
                className="div-style-content2"
                src={LockIcon}
                alt=""
              />
              <div
      ...
      <div style={{ marginTop: '0.6rem' }} className="popup-container">
        ...
        <Link
          to={redirectPath}
          style={{ textDecoration: 'none', zIndex: '200' }}
        >
