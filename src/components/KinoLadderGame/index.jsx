                    ...
                    <div style={{
                        ...
                        <div style={{ marginRight: '' }} className="kinoladdergame-content13">
                            ...
                            <div style={{ height: '3.65rem' }}>
                                <p style={{ fontSize: '2.4375rem', color: '#444444' }} className="kinoladdergame-content17">1.95</p>
                            </div>
                        </div>
                        ...
                        <div className="kinoladdergame-content18">
                            ...
                            <div style={{ height: '3.65rem' }}>
                                <p style={{ fontSize: '2.4375rem', color: '#444444' }} className="kinoladdergame-content22">1.95</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                >
                    ...
                    <div style={{
                        ...
                        <div style={{ marginRight: '' }} className="three-card-content3">
                            ...
                            <div style={{ height: '3.65rem' }}>
                                <p style={{ fontSize: '2.4375rem', color: '#444444' }} className="three-card-content9">3.80</p>
                            </div>
                        </div>
                        ...
                        <div style={{ marginRight: '' }} className="three-card-content10">
                            ...
                            <div style={{ height: '3.65rem' }}>
                                <p style={{ fontSize: '2.4375rem', color: '#444444' }} className="three-card-content16">3.80</p>
                            </div>
                        </div>
                        ...
                        <div style={{ marginRight: '' }} className="three-card-content17">
                            ...
                            <div style={{ height: '3.65rem' }}>
                                <p style={{ fontSize: '2.4375rem', color: '#444444' }} className="three-card-content23">3.80</p>
                            </div>
                        </div>
