          ...
          >
            ...
            <div
              style={{
                ...
                top: '-0.3rem',
                right:
                  item.departureNumberDirection === 'right' ? '-0.5rem' : '',
                left: item.departureNumberDirection === 'left' ? '-0.5rem' : '',
              }}
              className={`powerladderresults-content8`}
            >
    ...
    <div className="powerladderresults-container">
      <div className="powerladderresults-content">
        <div
          ...
          className="powerladderresults-content1"
        >
          <div
            style={{
              height: '5.25rem',
            ...
            className="powerladderresults-content2"
          >
            회차
          </div>
          <div
