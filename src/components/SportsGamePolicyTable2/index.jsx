...
const SportsGamePolicyTable2 = ({ array }) => {
    ...
    function Cells({ items }) {
        return items.map((item, index) => (
            <tr style={{ borderBottomWidth: `${items.length - 1 !== index ? "0.1875rem" : ""}`, borderBottom: "0.1875rem solid #252525", textAlign: 'center' }}>
    ...
    return (
        <div style={{ background: 'linear-gradient(to top, #1f1f1e, #3e3e3d 50%, #4a4a4a)', padding: '0.1875rem', margin: '2.5rem 1.875rem', borderRadius: "1.2rem", }}>
            <table style={{ borderRadius: "1.2rem", fontSize: '2.8125rem', background: '#323232', letterSpacing: '-0.07rem', borderCollapse: 'collapse', width: '100%' }} className="shadow-subNavbar">
