                ...
                <div className='content' >
                    ...
                    <div style={{ paddingTop: '5.625rem' }} className="bg-white pb-8">
                        ...
                        <div style={{ fontSize: '2.8125rem', padding: '1.8125rem 1.875rem' }}>
                            <div style={{ fontSize: '2.811875rem', letterSpacing: '-0.07rem', lineHeight: '1.8', marginTop: '-0.5rem', color: '#666666' }}>이벤트 중 주간 낙첨 포인트 지급은 21년 6월 7일 이후 베팅건 부터 아래와 같이 적용됩니다.</div>
                            <div
                            ...
                            <div style={{ marginBottom: '1.7rem' }}>
                                <span style={{ color: "#2980b9", letterSpacing: '-0.07rem', lineHeight: '1.8' }}>* 2021년 6월 7일 (월) 이후 베팅에 대한 낙첨쿠폰은 위 기준에 따라 제공<span style={{ letterSpacing: '-0.07rem', color: '#666666' }}>되오니 참고 부탁 드립니다.</span></span>
                            </div>
                        </div>
