...
const SportsGamePolicyTable1 = ({ array }) => {
    ...
    const Cell = ({
        ...
        <tr style={{ borderBottom: "0.1875rem solid #252525", textAlign: 'center' }} className={`bg-gray-fefefe tracking-tight text-gray-r585858  w-full border-b border-gray-dddddd`}>
            <td style={{ width: "14.8125rem", paddingLeft: '0rem', paddingRight: '0rem', color: typeColor, textAlign: 'center', lineHeight: '1.1' }} className=" text-center">
                {type.split('\n').map((item, i) =>
                    <p style={{ marginRight: '-1.2rem', marginTop: '0.2rem' }} key={i}>{item}</p>
                )}
            </td>
            <td style={{ width: "14.1875rem", color: overtime === null ? "#e65454" : overtime === true ? "#ffcc00" : "#929292" }} className=" text-center">
    ...
    return (
        <div style={{ background: 'linear-gradient(to top, #1f1f1e, #3e3e3d 50%, #4a4a4a)', boxShadow: '0 0 1rem 0 rgba(0, 0, 0, 0.6)', padding: '0.1875rem', margin: '0 1.875rem', borderRadius: "1.2rem", }}>
            <table style={{ borderRadius: "1.2rem", fontSize: '2.8125rem', background: '#323232', letterSpacing: '-0.07rem', borderCollapse: 'collapse', width:'100%' }} className="shadow-subNavbar overflow-hidden">
                <thead style={{ borderBottomWidth: "0.1875rem", background: '#2e2e2e', borderBottom: '0.1875rem solid #252525', borderTopLeftRadius: '1.3rem', borderTopRightRadius: '1.3rem' }} className="bg-gray-fafafa  tracking-tight text-gray-r454545 border-b border-gray-dddddd">
                ...
                <tbody style={{ fontSize: '2.625rem', color: '#c8c8c8' }} className="w-full text-585858 tracking-tight">
