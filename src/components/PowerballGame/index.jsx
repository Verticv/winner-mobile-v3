...
const PowerballGame = ({ state, setChosen, setSelectedOption }) => {
      ...
      >
        <div
          style={{
            ...
            borderRight:
              missingBorder === 'both' || missingBorder === 'right'
                ? ``
                : '0.1875rem solid',
            borderLeft:
              missingBorder === 'both' || missingBorder === 'left'
                ? ``
                : '0.1875rem solid',
          ...
          >
            ...
            >
              <p
                style={{
                  marginTop: '0.35rem',
                  letterSpacing: titleNumber === 10 ? '0.1rem' : '',
                }}
                className={`${
                  (titleNumber === 6 || titleNumber === 8) && ''
                } betoptions-style5`}
              >
                [{titleNumber}게임] {type}
              </p>
            ...
            <div
              style={{ fontSize: '2.625rem', marginLeft: '0.75rem' }}
              className="betoptions-style6"
            >
              <div className="betoptions-style7" style={{color: '#444444'}}>
                {subText}
                {subText2 ? `/${subText2}` : ''}{' '}
              </div>
            </div>
          ...
          {titleNumber === 1 || titleNumber === 6 ? (
            ...
            >
              <div className="betoptions-style9">
                ...
                >
                  <img
                    style={{ width: '11.375rem', maxWidth: 'unset' }}
                    className="betoptions-style11"
                    src={
                      state === `${titleNumber}-1`
                        ? BlueButtonPressed
                        : BlueButton
              ...
              <div className="betoptions-style14">
                ...
                <div style={{ height: '3.65rem' }}>
                  <p
                    style={{ fontSize: '2.4375rem', marginLeft: '-0.4rem', color: '#444444' }}
                    className="betoptions-style18"
                  >
                    1.95
                  </p>
                </div>
            ...
            >
              <div className="betoption-content1">
                ...
                <div style={{ height: '3.65rem' }}>
                  <p
                    style={{ fontSize: '2.4375rem', color: '#444444' }}
                    className="betoption-content8"
                  >
                    1.95
                  </p>
                </div>
                ...
                <div className="betoption-content-1">
                  ...
                  >
                    <img
                      style={{ width: '11.375rem', maxWidth: 'unset' }}
                      className={`${
                        state === `${titleNumber}-4` && 'indexstyle'
                      }  betoption-content3`}
                      src={
                        state === `${titleNumber}-4`
                          ? YellowButtonPressed
                ...
                <div className="betoption-content-1">
                  ...
                  >
                    <img
                      style={{ width: '11.375rem', maxWidth: 'unset' }}
                      className={`${
                        state === `${titleNumber}-5` && 'indexstyle'
                      }  betoption-content3`}
                      src={
                        state === `${titleNumber}-5`
                          ? YellowButtonPressed
                ...
                <div className="betoption-content-1">
                  ...
                  >
                    <img
                      style={{ width: '11.375rem', maxWidth: 'unset' }}
                      className={`${
                        state === `${titleNumber}-6` && 'indexstyle'
                      }  betoption-content3`}
                      src={
                        state === `${titleNumber}-6`
                          ? YellowButtonPressed
                ...
                <div className="betoption-content-1">
                  ...
                  >
                    <img
                      style={{ width: '11.375rem', maxWidth: 'unset' }}
                      className={`${
                        state === `${titleNumber}-7` && 'indexstyle'
                      }  betoption-content3`}
                      src={
                        state === `${titleNumber}-7`
                          ? YellowButtonPressed
                ...
                <div className="betoption-content-1">
                  ...
                  >
                    <img
                      style={{ width: '11.375rem', maxWidth: 'unset' }}
                      className={`${
                        state === `${titleNumber}-8` && 'indexstyle'
                      }  betoption-content3`}
                      src={
                        state === `${titleNumber}-8`
                          ? YellowButtonPressed
                ...
                <div className="betoption-content-1">
                  ...
                  >
                    <img
                      style={{ width: '11.375rem', maxWidth: 'unset' }}
                      className={`${
                        state === `${titleNumber}-9` && 'indexstyle'
                      }  betoption-content3`}
                      src={
                        state === `${titleNumber}-9`
                          ? YellowButtonPressed
                ...
                <div className="betoption-content-1">
                  ...
                  >
                    <img
                      style={{ width: '11.375rem', maxWidth: 'unset' }}
                      className={`${
                        state === `${titleNumber}-10` && 'indexstyle'
                      }  betoption-content3`}
                      src={
                        state === `${titleNumber}-10`
                          ? YellowButtonPressed
                          : YellowButton
                      }
                      alt=""
  ...
  return (
    <div style={{ width: '1260px' }} className="containerball">
